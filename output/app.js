...
(function(exports) {
  ...
  var replaceBubble = function (cycle) {
      return function (maxInt) {
          return function (bubble) {
              ...
              var $$new = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v)(maxInt + 1 | 0);
              if (cycle) {
              ...
              return function (bubbles) {
                  return function (idx) {
                      return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(function ($102) {
                          return replaceBubble(cycle)(maxInt)(Component_Bubble.cubeBy(inc.cubeBy)(inc.sqrBy)(inc.multBy)(inc.addTo)($102));
                      })(bubbles))(function (v) {
  ...
  var getFullMax = function (model) {
      ...
      throw new Error("Failed pattern match at Component.Canvas line 117, column 5 - line 119, column 49: " + [ model.norm.constructor.name ]);
  };
...
(function(exports) {
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App line 108, column 1 - line 108, column 80: " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      maxInt: 728,
