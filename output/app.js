...
(function(exports) {
  ...
  var Halogen_VDom_Types = PS["Halogen.VDom.Types"];
  var Prelude = PS["Prelude"];                 
  var Numeric = function (toNumeric) {
      this.toNumeric = toNumeric;
  };
  var toNumeric = function (dict) {
      return dict.toNumeric;
  };
  var svgns = "http://www.w3.org/2000/svg";
  var svgNamespace = svgns;
  var numericNum = new Numeric(Control_Category.identity(Control_Category.categoryFn));
  var numericInt = new Numeric(Data_Int.toNumber);
...
})(PS["HalogenHelpers.SVG.Internal"] = PS["HalogenHelpers.SVG.Internal"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_VDom_Types = PS["Halogen.VDom.Types"];
  var HalogenHelpers_SVG_Internal = PS["HalogenHelpers.SVG.Internal"];
  var Prelude = PS["Prelude"];
  ...
  var keyedSvgElement = Halogen_HTML_Elements.keyedNS(HalogenHelpers_SVG_Internal.svgNamespace);
  var svg = keyedSvgElement("svg");  
  ...
  var circle = function (props) {
      return keyedSvgElement("circle")(props)([  ]);
  };
  exports["svg"] = svg;
  ...
  exports["fill"] = fill;
})(PS["HalogenHelpers.SVG.Keyed"] = PS["HalogenHelpers.SVG.Keyed"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Semiring = PS["Data.Semiring"];
...
(function(exports) {
  ...
  var HalogenHelpers_Coordinates = PS["HalogenHelpers.Coordinates"];
  var HalogenHelpers_SVG_Internal = PS["HalogenHelpers.SVG.Internal"];
  var HalogenHelpers_SVG_Keyed = PS["HalogenHelpers.SVG.Keyed"];
  var $$Math = PS["Math"];
  var Norm = PS["Norm"];
  ...
  var ChangeZoom = (function () {
      function ChangeZoom(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeZoom.create = function (value0) {
          return function (value1) {
              return new ChangeZoom(value0, value1);
          };
      };
      return ChangeZoom;
  })();
  ...
  var normalizeCoords = function (model) {
      return function (coords) {
          var offset = {
              top: model.zoom * Data_Int.toNumber(model.scale),
  ...
  var incBubble = function (maxInt) {
      return function (def) {
          return function (bubbles) {
              return function (idx) {
                  return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(function ($86) {
                      return replaceBubble(maxInt)(def)(Component_Bubble.incValue($86));
                  })(bubbles))(function (v) {
              ...
              if (v1.animate) {
                  ...
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $81.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $81;
                      }))(function () {
...
(function(exports) {
  ...
  var SetZoom = (function () {
      function SetZoom(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetZoom.create = function (value0) {
          return function (value1) {
              return new SetZoom(value0, value1);
          };
      };
      return SetZoom;
  })();
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof SetZoom) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeZoom.create(Data_Int.toNumber(v.value0) / zoomDiv)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof ToggleRepr) {
      ...
      throw new Error("Failed pattern match at Component.App line 112, column 1 - line 112, column 80: " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      maxInt: initMaxInt,
