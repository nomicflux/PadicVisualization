...
(function($PS) {
  ...
  var IncValues = (function () {
      function IncValues(value0) {
          this.value0 = value0;
      };
      IncValues.create = function (value0) {
          return new IncValues(value0);
      };
      return IncValues;
  })();
  ...
  var toggleRepr = function (model) {
      var newRepr = (function () {
          ...
          throw new Error("Failed pattern match at Component.Canvas (line 336, column 17 - line 338, column 32): " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          power: model.power,
  ...
  var mkColor = function (model) {
      return function (value) {
          ...
          var divisor = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 178, column 17 - line 181, column 7): " + [ model.coordType.constructor.name ]);
          })();
          ...
          return function (colorGetter) {
              return function (radius) {
                  return function (bubbles) {
                      return Data_Foldable.for_(Effect.applicativeEffect)(Data_List_Types.foldableList)(distributeTuple(bubbles))(drawBubble(ctx)(coordGetter)(colorGetter)(radius));
                  };
              };
          };
      };
  ...
  var changeMax = function (power) {
      return function (model) {
          var x = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 348, column 11 - line 351, column 3): " + [ model.norm.constructor.name ]);
          })();
          return {
      ...
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Array.mapWithIndex(function (idx) {
                  return function (vs) {
                      return drawBubbles(v1)(coordGetter)(colorGetter)(model.radius)(new Data_Tuple.Tuple(idx, vs));
                  };
              })(model.bubbles))();
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at Component.Canvas (line 363, column 5 - line 372, column 18): " + [ v.constructor.name ]);
      };
  };
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(regenBubbles))(function () {
              ...
              var cache = (function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas (line 318, column 15 - line 322, column 85): " + [ v.coordType.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $77 = {};
                  for (var $78 in v1) {
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof MoveTick) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              ...
              if (v1.animate) {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas (line 418, column 7 - line 426, column 40): " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas (line 412, column 3 - line 426, column 40): " + [ v1.animate.constructor.name ]);
          });
      };
      ...
      throw new Error("Failed pattern match at Component.Canvas (line 382, column 1 - line 382, column 56): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App (line 136, column 1 - line 136, column 80): " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      power: 5,
