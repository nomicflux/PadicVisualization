(() => {
  // output/Component.Canvas/foreign.js
              ...
              function go2(bot, top3) {
                switch (top3 - bot) {
                  ...
                  default:
                    ...
                    return apply2(map29(concat22)(go2(bot, pivot)))(go2(pivot, top3));
                }
              }
  ...
  var proportionalTick = function(dictMonadReader) {
    ...
    return function(v) {
      ...
      ;
      if (v instanceof Just) {
        return bind8(ask2)(function(x) {
          return pure14(toNumber(v.value0) / toNumber(x));
        });
      }
      ;
  ...
  var interpolate = function(dictMonadReader) {
    ...
    var bind8 = bind(Monad0.Bind1());
    var proportionalTick1 = proportionalTick(dictMonadReader);
    var pure14 = pure(Monad0.Applicative0());
    return function(f) {
      return function(t) {
        return bind8(proportionalTick1(t))(function(prop6) {
          return pure14(function(to) {
            return function(from2) {
              return (to - from2) * f(prop6) + from2;
            };
          });
        });
      };
  ...
  var linInterpolate = function(dictMonadReader) {
    return interpolate(dictMonadReader)(identity6);
  };
  var sinInterpolate = function(dictMonadReader) {
    return interpolate(dictMonadReader)(function() {
      var $78 = flip(pow2)(2);
      return function($79) {
        return $78(sin(function(x) {
          return pi * x - pi / 4;
        }($79)));
      };
    }());
  };
  var sqrtInterpolate = function(dictMonadReader) {
    var unstretch = function(x) {
      return (x + 1) * 0.5;
    };
    ...
    return interpolate(dictMonadReader)(function($80) {
      return unstretch(cbrt(stretch($80)));
    });
  };
  var eqTick = {
    eq: function(x) {
  ...
  var constInterpolate = function(dictMonadReader) {
    return interpolate(dictMonadReader)($$const(0));
  };
  ...
  var incTick = function(dictMonadReader) {
    var Monad0 = dictMonadReader.MonadAsk0().Monad0();
    var bind8 = bind(Monad0.Bind1());
    var atMax1 = atMax(dictMonadReader);
    var pure14 = pure(Monad0.Applicative0());
    return function(v) {
      return bind8(atMax1(v))(function(maxxed) {
        if (maxxed) {
  ...
  var reduce = function(dictOrd) {
    ...
    var abs4 = abs(dictOrd);
    return function(dictEuclideanRing) {
      var gcd1 = gcd3(dictEuclideanRing);
      var div6 = div(dictEuclideanRing);
      ...
      return function(n) {
        return function(d) {
          var g = gcd1(n)(d);
          var d$prime = div6(d)(g);
          return new Ratio(mul2(div6(n)(g))(signum1(d$prime)), abs1(d$prime));
        };
      };
    };
  };
  var semiringRatio = function(dictOrd) {
    ...
    return function(dictEuclideanRing) {
      ...
      return {
        ...
        add: function(v) {
          return function(v1) {
            return reduce22(add2(mul2(v.value0)(v1.value1))(mul2(v.value1)(v1.value0)))(mul2(v.value1)(v1.value1));
          };
        }
      };
    };
  ...
  var Padic = /* @__PURE__ */ function() {
    function Padic2(value0) {
      this.value0 = value0;
    }
    ;
    Padic2.create = function(value0) {
      return new Padic2(value0);
    };
    return Padic2;
  }();
  var takeNorm = function(v) {
    return function(v1) {
      if (v1 === 0) {
        return fromInt(0);
      }
      ;
      if (v instanceof Inf) {
        return fromInt(abs3(v1));
      }
      ;
      if (v instanceof Padic) {
        var takeNormPower = function(m) {
          if (mod2(m)(v.value0) === 0) {
            return 1 + takeNormPower(div2(m)(v.value0)) | 0;
          }
          ;
          if (otherwise) {
            return 0;
          ...
          ;
          throw new Error("Failed pattern match at Norm (line 24, column 9 - line 26, column 26): " + [m.constructor.name]);
        };
        return reduce3(1)(pow(v.value0)(takeNormPower(v1)));
      }
      ;
      throw new Error("Failed pattern match at Norm (line 20, column 1 - line 20, column 36): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var isPadic = function(v) {
    if (v instanceof Inf) {
      return false;
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Norm (line 16, column 1 - line 16, column 27): " + [v.constructor.name]);
  };
  var getPrime = function(v) {
    if (v instanceof Inf) {
      return Nothing.value;
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Norm (line 12, column 1 - line 12, column 30): " + [v.constructor.name]);
  };
    ...
    var go2 = function(v) {
      return function(v1) {
        ...
        if (v1 instanceof Cons2) {
          return new Cons2(v1.value0, take3(v - 1 | 0)(v1.value1));
        }
        ;
  ...
  var replicate2 = function(i2) {
    return function(xs) {
      return take3(i2)(repeat(xs));
    };
  };
  ...
  // output/Roots/index.js
  var mod3 = /* @__PURE__ */ mod(euclideanRingInt);
  var div3 = /* @__PURE__ */ div(euclideanRingInt);
  var gcd2 = /* @__PURE__ */ gcd(eqInt)(euclideanRingInt);
  var map8 = /* @__PURE__ */ map(functorList);
  var fromFoldable4 = /* @__PURE__ */ fromFoldable3(ordInt)(foldableList);
  var fromFoldableWith2 = /* @__PURE__ */ fromFoldableWith(ordInt)(foldableList);
  ...
  var recipMod = function(v) {
    return function(v1) {
          ...
          return function($copy_v4) {
            return function($copy_v5) {
              ...
              function $tco_loop(v2, v3, v4, v5) {
                ...
                var q2 = div3(v4)(v5);
                $tco_var_v2 = v3;
                $tco_var_v3 = v2 - (q2 * v3 | 0) | 0;
                $tco_var_v4 = v5;
                $copy_v5 = v4 - (q2 * v5 | 0) | 0;
                return;
              }
              ;
              while (!$tco_done) {
                $tco_result = $tco_loop($tco_var_v2, $tco_var_v3, $tco_var_v4, $copy_v5);
              }
              ;
              return $tco_result;
            };
      ...
      var $38 = gcd2(v)(v1) === 1;
      if ($38) {
        return new Just(go2(0)(1)(v)(v1));
      }
      ;
      return Nothing.value;
    };
  };
  var modRecips = function(p2) {
    var ints = range3(0)(p2 - 1 | 0);
    var inverted = map8(function(x) {
      return new Tuple(x, recipMod(p2)(x));
    })(ints);
    return fromFoldable4(inverted);
  };
  var lookupOr = function(dictOrd) {
    var lookup8 = lookup(dictOrd);
    return function(key) {
      return function(def) {
        return function(m) {
          return fromMaybe(def)(lookup8(key)(m));
        };
      };
    };
  };
  var lookupOr1 = /* @__PURE__ */ lookupOr(ordInt);
  var joinLists = function(ls) {
    return function(rs) {
      return concat2(new Cons(ls, new Cons(rs, Nil.value)));
    };
  };
  var modCubeRoots = function(p2) {
    var ints = range3(0)(p2 - 1 | 0);
    var squared = map8(function(x) {
      return new Tuple(mod3((x * x | 0) * x | 0)(p2), singleton5(x));
    })(ints);
    return fromFoldableWith2(joinLists)(squared);
  };
  var pCbrt = function(v) {
    return function(v1) {
      return function(v2) {
        if (v2 === 0) {
          return new Cons(0, Nil.value);
        }
        ;
        var roots = modCubeRoots(v);
        var recips = modRecips(v);
        var go2 = function($copy_pk) {
          return function($copy_step) {
            return function($copy_n) {
              return function($copy_df) {
                var $tco_var_pk = $copy_pk;
                var $tco_var_step = $copy_step;
                var $tco_var_n = $copy_n;
                var $tco_done = false;
                var $tco_result;
                function $tco_loop(pk, step4, n, df) {
                  if (step4 >= v1) {
                    $tco_done = true;
                    return n;
                  }
                  ;
                  if (otherwise) {
                    var f = div3(((n * n | 0) * n | 0) - v2 | 0)(pk);
                    var d = mod3(f * (v - df | 0) | 0)(v);
                    $tco_var_pk = v * pk | 0;
                    $tco_var_step = step4 + 1 | 0;
                    $tco_var_n = n + (d * pk | 0) | 0;
                    $copy_df = df;
                    return;
                  }
                  ;
                  throw new Error("Failed pattern match at Roots (line 85, column 5 - line 85, column 42): " + [pk.constructor.name, step4.constructor.name, n.constructor.name, df.constructor.name]);
                }
                ;
                while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_pk, $tco_var_step, $tco_var_n, $copy_df);
                }
                ;
                return $tco_result;
              };
        ...
        var getRoot = function(n) {
          return lookupOr1(mod3(n)(v))(Nil.value)(roots);
        };
        var getRecip = function(n) {
          return fromFoldable1(lookupOr1(mod3(n)(v))(Nothing.value)(recips));
        };
        return bind3(getRoot(v2))(function(y) {
          return bind3(getRecip((3 * y | 0) * y | 0))(function(df) {
            return pure2(go2(v)(1)(y)(df));
          });
        });
      };
    };
  };
  var modRoots = function(p2) {
    var ints = range3(0)(p2 - 1 | 0);
    var squared = map8(function(x) {
      return new Tuple(mod3(x * x | 0)(p2), singleton5(x));
    })(ints);
    return fromFoldableWith2(joinLists)(squared);
  };
  var pSqrt = function(v) {
    return function(v1) {
      return function(v2) {
        if (v2 === 0) {
          return new Cons(0, Nil.value);
            ...
            return function($copy_n) {
              return function($copy_df) {
                ...
                function $tco_loop(pk, step4, n, df) {
                  ...
                  ;
                  throw new Error("Failed pattern match at Roots (line 61, column 5 - line 61, column 42): " + [pk.constructor.name, step4.constructor.name, n.constructor.name, df.constructor.name]);
                }
                ;
                while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_pk, $tco_var_step, $tco_var_n, $copy_df);
        ...
        return bind3(getRoot(v2))(function(y) {
          return bind3(getRecip(2 * y | 0))(function(df) {
            return pure2(go2(v)(1)(y)(df));
          });
        });
      };
  ...
  // output/Component.Bubble/index.js
  var normSqrt = function(v) {
    return function(v1) {
      if (v instanceof Inf) {
        return function($14) {
          return singleton5(round2(sqrt(toNumber($14))));
        };
      }
      ;
      if (v instanceof Padic) {
        return pSqrt(v.value0)(v1);
      }
      ;
      throw new Error("Failed pattern match at Component.Bubble (line 15, column 1 - line 15, column 45): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var normCbrt = function(v) {
    return function(v1) {
      if (v instanceof Inf) {
        var $15 = flip(pow2)(1 / 3);
        return function($16) {
          return singleton5(round2($15(toNumber($16))));
        };
      }
      ;
      if (v instanceof Padic) {
        return pCbrt(v.value0)(v1);
      }
      ;
      throw new Error("Failed pattern match at Component.Bubble (line 19, column 1 - line 19, column 45): " + [v.constructor.name, v1.constructor.name]);
    };
  };
  var cubeBy = function(cube) {
    return function(sqr) {
      return function(by) {
        return function(plus) {
          return function(v) {
            return (((((v * v | 0) * v | 0) * cube | 0) + ((v * v | 0) * sqr | 0) | 0) + (v * by | 0) | 0) + plus | 0;
          };
        };
      };
    };
  ...
  // output/HalogenHelpers.Coordinates/index.js
  var scale2 = function(n) {
  ...
  var addOffset = function(coordinates) {
  ...
  // output/PolarCoordinates/index.js
  var polarToCartesian = function(coords2) {
    return {
      x: coords2.r * cos(coords2.theta),
      y: coords2.r * sin(coords2.theta)
    };
  };
  var mkPolar = function(r) {
  ...
  // output/PadicVector/index.js
  var mod4 = /* @__PURE__ */ mod(euclideanRingInt);
  var div5 = /* @__PURE__ */ div(euclideanRingInt);
  var fromFoldable5 = /* @__PURE__ */ fromFoldable2(foldableList2);
  var mapWithIndex3 = /* @__PURE__ */ mapWithIndex2(functorWithIndexList);
  ...
  var calcStep = function(p2) {
    return function(n) {
      return function(d) {
        var theta = tau / toNumber(p2) * toNumber(d);
        var r = 1 / toNumber(pow(p2)(n));
        return mkPolar(r)(theta);
      };
    };
  };
  var toCoordList = function(maxLength3) {
    return function(p2) {
      return function(x) {
        var padic = padicRep(p2)(x);
        var extra = fromFoldable5(replicate2(maxLength3 - length4(padic) | 0)(0));
        return mapWithIndex3(calcStep(p2))(append6(padic)(extra));
      };
    };
  };
  var baseCoordinates = {
  ...
  var toVector = function(max7) {
    return function(p2) {
      return function(x) {
        ...
        var cl = toCoordList(length4(maxP) + 1 | 0)(p2)(x);
        return foldl5(function(acc) {
          return function(next) {
            return addCoords(acc)(polarToCartesian(next));
          };
        })(baseCoordinates)(cl);
      };
    };
  ...
  // output/Component.Canvas/index.js
  ...
  var linInterpolate2 = /* @__PURE__ */ linInterpolate(monadReaderReaderT2);
  var constInterpolate2 = /* @__PURE__ */ constInterpolate(monadReaderReaderT2);
  ...
  var Circular = /* @__PURE__ */ function() {
    ...
    ;
    Circular2.value = new Circular2();
    return Circular2;
  }();
  var PadicVector = /* @__PURE__ */ function() {
    function PadicVector2() {
    }
    ;
    PadicVector2.value = new PadicVector2();
    return PadicVector2;
  }();
  var ChangeMax = /* @__PURE__ */ function() {
    function ChangeMax2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeMax2.create = function(value0) {
      return new ChangeMax2(value0);
    };
    return ChangeMax2;
  }();
  var ChangeTick = /* @__PURE__ */ function() {
    function ChangeTick2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeTick2.create = function(value0) {
      return new ChangeTick2(value0);
    };
    return ChangeTick2;
  }();
  var ChangeNorm = /* @__PURE__ */ function() {
    function ChangeNorm2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeNorm2.create = function(value0) {
      return new ChangeNorm2(value0);
    };
    return ChangeNorm2;
  }();
  var ChangeScale = /* @__PURE__ */ function() {
    function ChangeScale2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeScale2.create = function(value0) {
      return new ChangeScale2(value0);
    };
    return ChangeScale2;
  }();
  var ChangeRadius = /* @__PURE__ */ function() {
    function ChangeRadius2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeRadius2.create = function(value0) {
      return new ChangeRadius2(value0);
    };
    return ChangeRadius2;
  }();
  var ChangeAddTo = /* @__PURE__ */ function() {
    function ChangeAddTo2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeAddTo2.create = function(value0) {
      return new ChangeAddTo2(value0);
    };
    return ChangeAddTo2;
  }();
  var ChangeMultBy = /* @__PURE__ */ function() {
    function ChangeMultBy2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeMultBy2.create = function(value0) {
      return new ChangeMultBy2(value0);
    };
    return ChangeMultBy2;
  }();
  var ChangeQuadBy = /* @__PURE__ */ function() {
    function ChangeQuadBy2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeQuadBy2.create = function(value0) {
      return new ChangeQuadBy2(value0);
    };
    return ChangeQuadBy2;
  }();
  var ChangeCubeBy = /* @__PURE__ */ function() {
    function ChangeCubeBy2(value0) {
      this.value0 = value0;
    }
    ;
    ChangeCubeBy2.create = function(value0) {
      return new ChangeCubeBy2(value0);
    };
    return ChangeCubeBy2;
  }();
  var ChangeSqrt = /* @__PURE__ */ function() {
    function ChangeSqrt3(value0) {
      this.value0 = value0;
    }
    ;
    ChangeSqrt3.create = function(value0) {
      return new ChangeSqrt3(value0);
    };
    return ChangeSqrt3;
  }();
  var ChangeCbrt = /* @__PURE__ */ function() {
    function ChangeCbrt3(value0) {
      this.value0 = value0;
    }
    ;
    ChangeCbrt3.create = function(value0) {
      return new ChangeCbrt3(value0);
    };
    return ChangeCbrt3;
  }();
  ...
  var ToggleRepr = /* @__PURE__ */ function() {
    ...
    ;
    ToggleRepr3.value = new ToggleRepr3();
    return ToggleRepr3;
  }();
  var ToggleLines = /* @__PURE__ */ function() {
    function ToggleLines3() {
    }
    ;
    ToggleLines3.value = new ToggleLines3();
    return ToggleLines3;
  }();
  var ToggleAnimation = /* @__PURE__ */ function() {
    ...
    ;
    ToggleAnimation3.value = new ToggleAnimation3();
    return ToggleAnimation3;
  }();
  var InitCaches = /* @__PURE__ */ function() {
    function InitCaches2() {
    }
    ;
    InitCaches2.value = new InitCaches2();
    return InitCaches2;
  }();
  var Reset = /* @__PURE__ */ function() {
    ...
    ;
    Reset3.value = new Reset3();
    return Reset3;
  }();
  var MoveTick = /* @__PURE__ */ function() {
    function MoveTick2() {
    }
    ;
    MoveTick2.value = new MoveTick2();
    return MoveTick2;
  }();
  var ReceiveAction = /* @__PURE__ */ function() {
    function ReceiveAction3(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    ReceiveAction3.create = function(value0) {
      return function(value1) {
        return new ReceiveAction3(value0, value1);
      };
    };
    return ReceiveAction3;
  }();
  var toggleRepr = function(model) {
    var newRepr = function() {
      ...
      ;
      throw new Error("Failed pattern match at Component.Canvas (line 355, column 17 - line 357, column 32): " + [model.coordType.constructor.name]);
    }();
    return {
      maxInt: model.maxInt,
  ...
  var normalizeCoords = function(model) {
    return function(coords2) {
      var offset = {
        top: 1.5 * toNumber(model.scale),
        left: 1.5 * toNumber(model.scale)
      };
      return addOffset(scale2(toNumber(model.scale))(coords2))(offset);
    };
  };
  var mkColor = function(model) {
    return function(value12) {
      var scale3 = toNumber(model.maxValue + 1 | 0);
      var base2 = atan(log(value12 / scale3));
      var hue = 360 * base2;
      var sat = 1 - (base2 * 0.4 + 0.6);
      var val = 1 - (base2 * 0.6 + 0.4);
      return toHexString(hsv(hue)(sat)(val));
    };
  };
  var mkBubbles = function(maxInt) {
    return map15(singleton5)(range(0)(maxInt));
  };
  ...
  var initialModel = function(input3) {
    var maxInt = pow(fromMaybe(1)(getPrime(input3.norm)))(input3.power);
    return {
      power: input3.power,
      norm: input3.norm,
      maxInt,
      ...
      lines: false,
      scale: input3.scale,
      radius: input3.radius,
      addTo: input3.addTo,
      multBy: input3.multBy,
      quadCoeff: input3.quadCoeff,
      cubeCoeff: input3.cubeCoeff,
      sqrt: input3.sqrt,
      cbrt: input3.cbrt,
      circuit: fromMaybe(empty3)(map16(singleton7)(input3.trajectoryFrom)),
      trajectoryFrom: input3.trajectoryFrom
    };
  };
  var getTheta = function(model) {
    return function(value12) {
      return tau * toNumber(mod5(value12)(model.maxInt)) / toNumber(model.maxInt);
    };
  };
  var getSize = function(model) {
    return round2(4 * toNumber(model.scale));
  };
  var getR = function(model) {
    return function(value12) {
      var maxValue = function() {
        var $104 = isPadic(model.norm);
        if ($104) {
          return 1;
        }
        ;
  ...
  var toPolar = function(model) {
    return function(n) {
      var theta = getTheta(model)(n);
      var r = getR(model)(takeNorm(model.norm)(n));
      return {
        r: toNumber2(r),
        theta
      };
  ...
  var getCoordinates = function(interpolater) {
    return function(cache) {
      return function(calcer) {
        return function(v) {
          var $$new2 = fromMaybe(calcer(v.value1))(lookup6(v.value1)(cache));
          var mold = lookup6(v.value0)(cache);
          var old = fromMaybe(calcer(v.value0))(mold);
          return {
            x: interpolater($$new2.x)(old.x),
            y: interpolater($$new2.y)(old.y)
          };
        };
      };
    };
  ...
  var getColor = function(interpolater) {
    return function(model) {
      return function(v) {
        return mkColor(model)(interpolater(toNumber(v.value0))(toNumber(v.value1)));
      };
    };
  };
  ...
  var getCoord = function(model) {
    return function(x) {
      if (model.coordType instanceof Circular) {
        return getCircleCoord(model)(x);
      }
      ;
      if (model.coordType instanceof PadicVector) {
        return getPadicCoord(model)(x);
      }
      ;
      throw new Error("Failed pattern match at Component.Canvas (line 147, column 20 - line 149, column 41): " + [model.coordType.constructor.name]);
    };
  };
      ...
      var go2 = function($copy_circuit) {
        return function($copy_acc) {
          ...
          function $tco_loop(circuit, acc) {
            ...
            ;
            throw new Error("Failed pattern match at Component.Canvas (line 317, column 22 - line 321, column 66): " + [circuit.constructor.name]);
          }
          ;
          while (!$tco_done) {
        ...
        return function(r) {
          return function(startColor) {
            return function(endColor) {
              return function __do2() {
                var gradient = createLinearGradient(ctx)({
                  x0: start2.x,
                  y0: start2.y,
                  x1: end.x,
                  y1: end.y
                })();
                addColorStop(gradient)(0)(startColor)();
                addColorStop(gradient)(1)(endColor)();
                setStrokeGradientStyle(ctx)(gradient)();
                setLineWidth(ctx)(r)();
                beginPath(ctx)();
                moveTo(ctx)(start2.x)(start2.y)();
    ...
    return function(coords2) {
      return function(r) {
        return function(color) {
          return function __do2() {
            beginPath(ctx)();
            moveTo(ctx)(coords2.x)(coords2.y)();
            arc(ctx)({
              x: coords2.x,
              y: coords2.y,
              radius: r,
  ...
  var drawBubble = function(ctx) {
    return function(model) {
      return function(oldCoordGetter) {
        return function(coordGetter) {
          return function(radius) {
            return function(v) {
              var linInterp = runReader(linInterpolate2(model.time))(model.maxTick);
              var constInterp = runReader(constInterpolate2(model.time))(model.maxTick);
              var bubble = new Tuple(v.value0, function() {
                var $130 = v.value1 < 0;
                if ($130) {
                  return mod5(v.value1)(model.maxValue);
                }
                ;
                return v.value1;
              }());
              var color = getColor(linInterp)(model)(bubble);
              var coords2 = coordGetter(bubble);
              var startColor = getColor(constInterp)(model)(bubble);
              var startCoords = oldCoordGetter(bubble);
              return applySecond2(drawCircle(ctx)(coords2)(toNumber(radius))(color))(function() {
                var $132 = model.lines || member3(bubble.value0)(model.circuit);
                if ($132) {
                  return drawLine(ctx)(startCoords)(coords2)(toNumber(radius))(startColor)(color);
                }
                ;
                return pure6(unit);
              }());
  ...
  var drawBubbles = function(ctx) {
    return function(model) {
      return function(oldCoordGetter) {
        return function(coordGetter) {
          return function(radius) {
            return function(bubbles2) {
              return for_2(distributeTuple(bubbles2))(drawBubble(ctx)(model)(oldCoordGetter)(coordGetter)(radius));
            };
          };
        };
      };
  ...
  var changeMax = function(power) {
    return function(model) {
      var x = function() {
        if (model.norm instanceof Padic) {
          return model.norm.value0;
        }
        ;
        if (model.norm instanceof Inf) {
          return 1;
        }
        ;
  ...
  var redraw = function(model) {
    ...
    var calcer = getCoord(model);
    var coordGetter = getCoordinates(sqrtInterp)(model.cache)(calcer);
    var oldCoordGetter = getCoordinates(function(v) {
      return function(y) {
        return y;
      };
    })(model.cache)(calcer);
    var alpha = sinInterp(0.6)(0.25);
    return function __do2() {
      ...
      if (mcanvas instanceof Just) {
        var $144 = fromMaybe(false)(map16(flip(member1)(model.drawnBuffers))(model.time));
        if ($144) {
          return unit;
        }
        ;
        ...
        sequence_2(mapWithIndex(function(idx) {
          return function(vs) {
            return drawBubbles(ctx)(model)(oldCoordGetter)(coordGetter)(model.radius)(new Tuple(idx, vs));
          };
        })(model.bubbles))();
        return unit;
      }
      ;
      throw new Error("Failed pattern match at Component.Canvas (line 385, column 5 - line 397, column 22): " + [mcanvas.constructor.name]);
    };
  };
    ...
    return discard22(modify_3(function(v) {
      ...
      return discard22(liftEffect3(redraw(model)))(function() {
        return discard22(modify_3(function(v) {
          ...
          ;
          $149.drawnBuffers = insert12(fromMaybe(0)(model.time))(model.drawnBuffers);
          return $149;
        }))(function() {
          return discard22(modify_3(function(v) {
            var $152 = {};
  ...
  var render = function(model) {
    ...
    return div4([id2("animation-station")])(map15(bufferCanvas(size5)(fromMaybe(0)(model.time)))(range(0)(model.maxInt)));
  };
  var bubbleFn = function(model) {
    var base2 = function() {
      var $229 = cubeBy(model.cubeCoeff)(model.quadCoeff)(model.multBy)(model.addTo);
      return function($230) {
        return singleton5($229($230));
      };
    }();
    var sqrted = function() {
      if (model.sqrt) {
        return composeKleisli2(base2)(normSqrt(model.norm)(2 * model.power | 0));
      }
      ;
      return base2;
    }();
    var cbrted = function() {
      if (model.cbrt) {
        return composeKleisli2(sqrted)(normCbrt(model.norm)(3 * model.power | 0));
      }
      ;
      return sqrted;
    }();
  ...
  var reinitCache = /* @__PURE__ */ discard22(/* @__PURE__ */ modify_3(regenBubbles))(function() {
    return bind12(modify5(incAll))(function(incedModel) {
      var outputInts = concatMap(fromFoldable12)(incedModel.bubbles);
      var newCircuit = followTrajectory(incedModel.bubbles)(incedModel.trajectoryFrom);
      var inputInts = range(0)(incedModel.maxInt);
      var ints = nub3(append22(inputInts)(outputInts));
      ...
      return bind12(modify5(function(v) {
        return {
          ...
          cache: v.cache,
          cbrt: v.cbrt,
          coordType: v.coordType,
          cubeCoeff: v.cubeCoeff,
          lines: v.lines,
          maxInt: v.maxInt,
          maxTick: v.maxTick,
          multBy: v.multBy,
        ...
        var cache = foldl2(function(acc) {
          return function(x) {
            return insert22(x)(getCoord(modelWithInts)(x))(acc);
          };
        })(empty2)(ints);
        return bind12(modify5(function(v) {
          return {
  ...
  var handleAction = function(v) {
    if (v instanceof ChangeMax) {
      return applySecond1(modify_3(changeMax(v.value0)))(reinitCache);
    }
    ;
    if (v instanceof ChangeNorm) {
      return applySecond1(modify_3(function(v1) {
        var $163 = {};
        for (var $164 in v1) {
        ...
        return discard22(function() {
          ...
          if (v.value0 instanceof Just) {
            return modify_3(function(v1) {
              ...
              ;
              $210.circuit = singleton7(v.value0.value0);
              return $210;
            });
          }
          ;
          throw new Error("Failed pattern match at Component.Canvas (line 435, column 3 - line 437, column 57): " + [v.value0.constructor.name]);
        }())(function() {
          return reinitCache;
        });
      });
    ...
    if (v instanceof ToggleRepr) {
      return applySecond1(modify_3(toggleRepr))(reinitCache);
    }
    ;
    if (v instanceof ToggleLines) {
      return applySecond1(modify_3(toggleLines))(reinitCache);
    }
    ;
    if (v instanceof ToggleAnimation) {
      return applySecond1(modify_3(toggleAnimation))(reinitCache);
    }
    ;
    if (v instanceof MoveTick) {
      return bind12(get2)(function(model) {
        ...
        ;
        if (model.animate) {
          var newTick = bind22(model.time)(function(t) {
            return runReader(incTick2(t))(model.maxTick);
          });
          ...
          ;
          throw new Error("Failed pattern match at Component.Canvas (line 450, column 7 - line 458, column 20): " + [newTick.constructor.name]);
        }
        ;
        throw new Error("Failed pattern match at Component.Canvas (line 444, column 3 - line 458, column 20): " + [model.animate.constructor.name]);
      });
    }
    ;
    ...
    if (v instanceof Reset) {
      return bind12(get2)(function(model) {
        return discard22(modify_3(changeMax(model.power)))(function() {
          return reinitCache;
        });
      });
    }
    ;
    throw new Error("Failed pattern match at Component.Canvas (line 411, column 1 - line 411, column 84): " + [v.constructor.name]);
  };
  var handleQuery = function(v) {
    return applySecond1(handleAction(v.value0))(pure1(new Just(v.value1)));
  };
  ...
  var partitionDefault = function(dictFilterable) {
    ...
    return function(p2) {
      return function(xs) {
        var o = partitionMap1(eitherBool(p2))(xs);
        return {
          no: o.left,
          yes: o.right
        };
  ...
  var filterableMaybe = {
    ...
    partition: function(p2) {
      return partitionDefault(filterableMaybe)(p2);
    },
    filterMap: /* @__PURE__ */ bindFlipped(bindMaybe),
    filter: function(p2) {
      return filterDefault(filterableMaybe)(p2);
    },
  ...
  var unsafeReadProp = function(dictMonad) {
    ...
    return function(k) {
      return function(value12) {
        return unsafeReadPropImpl(fail2(new TypeMismatch("object", typeOf(value12))), pure14, k, value12);
      };
    };
  };
  ...
  var addForeignPropHandler = function(key) {
    return function(prop6) {
      return function(reader) {
        return function(f) {
          var go2 = function(a2) {
            return composeKleisliFlipped2(reader)(readProp2(prop6))(unsafeToForeign(a2));
          };
    ...
    return function(dictIsSymbol) {
      ...
      return function(dictOrd) {
        ...
        return function(slot) {
          return function(label5) {
            return function(req) {
              return $$void6(query22(slot)(label5)(req(unit)));
            };
          };
        };
      };
  ...
  var tell3 = /* @__PURE__ */ tell2()(canvasIsSymbol)(ordUnit);
  ...
  var SetNorm = /* @__PURE__ */ function() {
    ...
    ;
    SetNorm2.create = function(value0) {
      return new SetNorm2(value0);
    };
    return SetNorm2;
  }();
  var SetMax = /* @__PURE__ */ function() {
    function SetMax2(value0) {
      this.value0 = value0;
    }
    ;
    SetMax2.create = function(value0) {
      return new SetMax2(value0);
    };
    return SetMax2;
  }();
  var SetTick = /* @__PURE__ */ function() {
    function SetTick2(value0) {
      this.value0 = value0;
    }
    ;
    SetTick2.create = function(value0) {
      return new SetTick2(value0);
    };
    return SetTick2;
  }();
  var SetScale = /* @__PURE__ */ function() {
    function SetScale2(value0) {
      this.value0 = value0;
    }
    ;
    SetScale2.create = function(value0) {
      return new SetScale2(value0);
    };
    return SetScale2;
  }();
  var SetRadius = /* @__PURE__ */ function() {
    function SetRadius2(value0) {
      this.value0 = value0;
    }
    ;
    SetRadius2.create = function(value0) {
      return new SetRadius2(value0);
    };
    return SetRadius2;
  }();
  var SetAdd = /* @__PURE__ */ function() {
    function SetAdd2(value0) {
      this.value0 = value0;
    }
    ;
    SetAdd2.create = function(value0) {
      return new SetAdd2(value0);
    };
    return SetAdd2;
  }();
  var SetMult = /* @__PURE__ */ function() {
    function SetMult2(value0) {
      this.value0 = value0;
    }
    ;
    SetMult2.create = function(value0) {
      return new SetMult2(value0);
    };
    return SetMult2;
  }();
  var SetQuad = /* @__PURE__ */ function() {
    function SetQuad2(value0) {
      this.value0 = value0;
    }
    ;
    SetQuad2.create = function(value0) {
      return new SetQuad2(value0);
    };
    return SetQuad2;
  }();
  var SetCube = /* @__PURE__ */ function() {
    function SetCube2(value0) {
      this.value0 = value0;
    }
    ;
    SetCube2.create = function(value0) {
      return new SetCube2(value0);
    };
    return SetCube2;
  }();
  var ChangeSqrt2 = /* @__PURE__ */ function() {
    function ChangeSqrt3(value0) {
      this.value0 = value0;
    }
    ;
  ...
  var ChangeCbrt2 = /* @__PURE__ */ function() {
    function ChangeCbrt3(value0) {
      this.value0 = value0;
    }
    ;
  ...
  var ToggleAnimation2 = /* @__PURE__ */ function() {
    function ToggleAnimation3() {
    }
    ;
    ToggleAnimation3.value = new ToggleAnimation3();
  ...
  var ToggleLines2 = /* @__PURE__ */ function() {
    function ToggleLines3() {
    }
    ;
    ToggleLines3.value = new ToggleLines3();
  ...
  var ReceiveAction2 = /* @__PURE__ */ function() {
    function ReceiveAction3(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
  ...
  var toNatural = /* @__PURE__ */ function() {
    var $43 = filter4(filterableMaybe)(function(v) {
      return v >= 0;
    });
    return function($44) {
  ...
  var baseInput = /* @__PURE__ */ function() {
    return {
      size: 1024,
      power: 5,
      norm: new Padic(3),
      coordType: PadicVector.value,
      maxTick: 64,
      scale: 200,
      radius: 1,
      addTo: 1,
  ...
  var passAlong = function(action2) {
    var toQuery = function(action1) {
      return ReceiveAction.create(action1);
    };
    return tell3(_canvas)(unit)(toQuery(action2));
  };
  var handleAction2 = function(v) {
    ...
    if (v instanceof SetNorm) {
      var norm = function() {
        ...
        ;
        return new Padic(v.value0);
      }();
      return applySecond3(applySecond3(passAlong(new ChangeNorm(norm)))(passAlong(Reset.value)))(pure7(unit));
    }
    ;
    if (v instanceof SetMax) {
      return applySecond3(passAlong(new ChangeMax(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetTick) {
      return applySecond3(passAlong(new ChangeTick(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetScale) {
      return applySecond3(passAlong(new ChangeScale(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetRadius) {
      return applySecond3(passAlong(new ChangeRadius(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetAdd) {
      return applySecond3(passAlong(new ChangeAddTo(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetMult) {
      return applySecond3(passAlong(new ChangeMultBy(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetQuad) {
      return applySecond3(passAlong(new ChangeQuadBy(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof SetCube) {
      return applySecond3(passAlong(new ChangeCubeBy(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof ChangeSqrt2) {
      return applySecond3(passAlong(new ChangeSqrt(v.value0)))(pure7(unit));
    }
    ;
    if (v instanceof ChangeCbrt2) {
    ...
    ;
    if (v instanceof ToggleLines2) {
      return applySecond3(passAlong(ToggleLines.value))(pure7(unit));
    }
    ;
    if (v instanceof ToggleAnimation2) {
      return applySecond3(passAlong(ToggleAnimation.value))(pure7(unit));
    }
    ;
    if (v instanceof Reset2) {
      return applySecond3(passAlong(Reset.value))(pure7(unit));
    }
    ;
  ...
  var render2 = function(v) {
    var withDescription = function(inputDiv) {
      return function(descr) {
        return function(class_2) {
          var descrDiv = maybe([])(function(txt) {
            return [div4([class_("description")])([text(txt)])];
          })(descr);
          return div4([class_(class_2)])(cons(inputDiv)(descrDiv));
        };
      };
    };
    ...
    var mkCheckbox = function(text6) {
      return function(descr) {
        return function(query3) {
          var inputDiv = div_([label_([text(text6 + ": ")]), input([class_("attr-boolean"), type_4(InputCheckbox.value), onChecked(query3), title(text6)])]);
          return withDescription(inputDiv)(descr)("checkbox-div");
        };
      };
    };
    var mkButton = function(text6) {
      return function(class_2) {
        return function(description) {
          return function(query3) {
            var buttonDiv = button([class_("pure-button button-" + class_2), onClick(function(v1) {
              return query3;
            }), type_1(ButtonButton.value)])([text(text6)]);
            return withDescription(buttonDiv)(description)("button-div");
          };
        };
      };
    };
  ...
  var selectElement = function(query3) {
    return bind5(liftEffect4(bindFlipped4(composeKleisliFlipped3(function() {
  ...
  var runUI2 = function(component3) {
    return function(i2) {
      return function(element3) {
        return bind15(liftEffect7(map28(toDocument)(bindFlipped7(document2)(windowImpl))))(function(document3) {
  ...
  var tickDelay = /* @__PURE__ */ function() {
    return 1 / 60;
  }();
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind7(awaitBody)(function(body2) {
    return bind7(runUI2(component2)(unit)(body2))(function(io) {
      return forever2(bind7(delay(tickDelay))(function() {
        return $$void9(io.query(mkTell(ReceiveAction2.create(Tick.value))));
      }));
    });
  }));
