...
(function($PS) {
  ...
  var incBubble = function (maxInt) {
      return function (inc) {
          return function (bubbles) {
              return function (idx) {
                  return function __do() {
                      var v = Data_Array_ST.modify(idx)(function ($123) {
                          return replaceBubble(maxInt)(inc)(Component_Bubble.cubeBy(inc.cubeBy)(inc.sqrBy)(inc.multBy)(inc.addTo)($123));
                      })(bubbles)();
                      return Data_Unit.unit;
                  };
              };
  ...
  var changeMax = function (power) {
      return function (model) {
          var x = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 318, column 11 - line 321, column 3): " + [ model.norm.constructor.name ]);
          })();
          return {
  ...
  var redraw = function (model) {
      ...
      return function __do() {
          ...
          throw new Error("Failed pattern match at Component.Canvas (line 333, column 5 - line 341, column 18): " + [ v.constructor.name ]);
      };
  };
  ...
  var $$eval = function (v) {
              ...
              if (v1.animate) {
                  ...
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $116.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $116;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(redrawStep)(function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas (line 383, column 7 - line 391, column 40): " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas (line 377, column 3 - line 391, column 40): " + [ v1.animate.constructor.name ]);
          });
      };
      ...
      throw new Error("Failed pattern match at Component.Canvas (line 351, column 1 - line 351, column 56): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App (line 130, column 1 - line 130, column 80): " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      power: 5,
