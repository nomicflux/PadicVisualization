...
(function(exports) {
  ...
  var incValue = modifyBubble(function (b) {
      return setValue(getValue(b) + 1 | 0)(b);
  });
  ...
  var decValue = modifyBubble(function (b) {
      return setValue(getValue(b) - 1 | 0)(b);
  });
...
(function(exports) {
  ...
  var Halogen_VDom_Types = PS["Halogen.VDom.Types"];
  var Prelude = PS["Prelude"];                 
  var Numeric = function (toInt) {
      this.toInt = toInt;
  };
  var width = function (dictNumeric) {
      return function (dictShow) {
          return function ($30) {
              return Halogen_HTML_Properties.attr("width")(Data_Show.show(dictShow)($30));
          };
      };
  };
  ...
  var r = function ($32) {
      return Halogen_HTML_Properties.attr("r")(Data_Show.show(Data_Show.showInt)($32));
  };
  var opacity = function (dictNumeric) {
      return function (dictShow) {
          return function ($33) {
              return Halogen_HTML_Properties.attr("opacity")(Data_Show.show(dictShow)($33));
          };
      };
  };
  var numericNum = new Numeric(function (n) {
      return Data_Int.round(n);
  });
  var numericInt = new Numeric(Control_Category.identity(Control_Category.categoryFn));
  var height = function (dictNumeric) {
      return function (dictShow) {
          return function ($34) {
              return Halogen_HTML_Properties.attr("height")(Data_Show.show(dictShow)($34));
          };
      };
  };
  var fill = Halogen_HTML_Properties.attr("fill");
  var cy = function (dictNumeric) {
      return function (dictShow) {
          return function ($35) {
              return Halogen_HTML_Properties.attr("cy")(Data_Show.show(dictShow)($35));
          };
      };
  };
  var cx = function (dictNumeric) {
      return function (dictShow) {
          return function ($36) {
              return Halogen_HTML_Properties.attr("cx")(Data_Show.show(dictShow)($36));
          };
      };
  };
  ...
  exports["numericNum"] = numericNum;
  exports["numericInt"] = numericInt;
})(PS["HalogenHelpers.SVG"] = PS["HalogenHelpers.SVG"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Data_Semiring = PS["Data.Semiring"];
...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var HalogenHelpers_Coordinates = PS["HalogenHelpers.Coordinates"];
  var HalogenHelpers_SVG = PS["HalogenHelpers.SVG"];
  var $$Math = PS["Math"];
  var Norm = PS["Norm"];
  ...
  var ChangeWinding = (function () {
      function ChangeWinding(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeWinding.create = function (value0) {
          return function (value1) {
              return new ChangeWinding(value0, value1);
          };
      };
      return ChangeWinding;
  })();
  ...
  var DecValues = (function () {
      function DecValues(value0) {
          this.value0 = value0;
      };
      DecValues.create = function (value0) {
          return new DecValues(value0);
      };
      return DecValues;
  })();
  ...
  var toggleRepr = function (model) {
      var newRepr = (function () {
          ...
          throw new Error("Failed pattern match at Component.Canvas line 269, column 17 - line 271, column 32: " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          norm: model.norm,
          ...
          time: model.time,
          size: model.size,
          windingNumber: model.windingNumber,
          ...
          return function (p) {
              return function (model) {
                  return function (bubble) {
                      ...
                      return HalogenHelpers_SVG.circle([ HalogenHelpers_SVG.cx(HalogenHelpers_SVG.numericNum)(Data_Show.showNumber)(coords.x), HalogenHelpers_SVG.cy(HalogenHelpers_SVG.numericNum)(Data_Show.showNumber)(coords.y), HalogenHelpers_SVG.r(1), HalogenHelpers_SVG.stroke(color), HalogenHelpers_SVG.fill(color), HalogenHelpers_SVG.opacity(HalogenHelpers_SVG.numericNum)(Data_Show.showNumber)(alpha) ]);
                  };
              };
          };
      };
  };
  var normalizeCoords = function (scale) {
      return function (coords) {
          var offset = {
              top: Data_Int.toNumber(2 * scale | 0),
              left: Data_Int.toNumber(2 * scale | 0)
          };
          return HalogenHelpers_Coordinates.addOffset(HalogenHelpers_Coordinates.scale(Data_Int.toNumber(scale))(coords))(offset);
      };
  };
  ...
  var initialModel = function (input) {
      return {
          maxInt: input.maxInt,
          norm: input.norm,
          bubbles: Data_Functor.map(Data_Functor.functorArray)(Component_Bubble.mkBubble)(Data_Array.range(0)(input.maxInt)),
  ...
  var incBubble = function (maxInt) {
      return function (def) {
          return function (bubbles) {
              return function (idx) {
                  return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(function ($89) {
                      return replaceBubble(maxInt)(def)(Component_Bubble.incValue($89));
                  })(bubbles))(function (v) {
  ...
  var incAll = function (model) {
      var def = Component_Bubble.mkBubble(0);
      var newBubblesST = function (bubbles) {
          return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.thaw(bubbles))(function (v) {
              return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Control_Monad_ST_Internal["for"](0)(Data_Array.length(bubbles))(incBubble(model.maxInt)(def)(v)))(function (v1) {
  ...
  var getTheta = function (model) {
      return function (value) {
          return ($$Math.pi * 2.0 * Data_Int.toNumber(value)) / Data_Int.toNumber(model.windingNumber);
      };
  };
  ...
  var getPadicCoord = function (model) {
      return function (n) {
          ...
          return normalizeCoords(model.scale)(PadicVector_1.toVector(model.maxInt)(p)(Component_Bubble.getValue(b)));
      };
  };
  var getCoordinates = function (interpolater) {
      return function (cache) {
          return function (bubble) {
              ...
              if (mold instanceof Data_Maybe.Nothing) {
                  return $$new;
              };
              if (mold instanceof Data_Maybe.Just) {
                  return {
                      x: interpolater($$new.x)(mold.value0.x),
                      y: interpolater($$new.y)(mold.value0.y)
                  };
              };
              throw new Error("Failed pattern match at Component.Canvas line 120, column 6 - line 125, column 8: " + [ mold.constructor.name ]);
          };
      };
  };
  var render = function (model) {
      ...
      var dblSizeStr = Data_Show.show(Data_Show.showInt)(4 * model.scale | 0);
      var coordGetter = getCoordinates(interpolater)(model.cache);
      var alpha = 0.2 + 0.7 * square($$Math.cos($$Math.pi * propTick));
      return Halogen_HTML_Elements.div_([ HalogenHelpers_SVG.svg([ HalogenHelpers_SVG.width(HalogenHelpers_SVG.numericInt)(Data_Show.showInt)(model.size), HalogenHelpers_SVG.height(HalogenHelpers_SVG.numericInt)(Data_Show.showInt)(model.size), HalogenHelpers_SVG.viewBox(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "0", "0", dblSizeStr, dblSizeStr ])) ])(Data_Functor.map(Data_Functor.functorArray)(renderBubble(coordGetter)(alpha)(p)(model))(model.bubbles)) ]);
  };
  var getCircleCoord = function (model) {
      return function (n) {
          var b = Component_Bubble.mkBubble(n);
          return normalizeCoords(model.scale)(PolarCoordinates.polarToCartesian(toPolar(model)(b)));
      };
  };
  var reinitCache = function (next) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          ...
          var cache = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas line 252, column 15 - line 256, column 85: " + [ v.coordType.constructor.name ]);
          })();
  ...
  var decBubble = function (maxInt) {
      return function (def) {
          return function (bubbles) {
              return function (idx) {
                  return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(Component_Bubble.decValue)(bubbles))(function (v) {
                      return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(replaceBubble(maxInt)(def))(bubbles))(function (v1) {
                          return Control_Applicative.pure(Control_Monad_ST_Internal.applicativeST)(Data_Unit.unit);
                      });
                  });
              };
  ...
  var decAll = function (model) {
      var def = Component_Bubble.mkBubble(model.maxInt);
      var newBubblesST = function (bubbles) {
          return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.thaw(bubbles))(function (v) {
              return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Control_Monad_ST_Internal["for"](0)(Data_Array.length(bubbles))(decBubble(model.maxInt)(def)(v)))(function (v1) {
                  return Data_Array_ST.freeze(v);
              });
          });
      };
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof DecValues) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(decAll))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          });
      };
              ...
              if (v1.animate) {
                  ...
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $84.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $84;
                      }))(function () {
                          return $$eval(new IncValues(v.value0(Data_Unit.unit)));
                      });
                  };
                  throw new Error("Failed pattern match at Component.Canvas line 299, column 7 - line 305, column 40: " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas line 295, column 3 - line 305, column 40: " + [ v1.animate.constructor.name ]);
          });
      };
      if (v instanceof InitCaches) {
          return reinitCache(v.value0);
      };
      throw new Error("Failed pattern match at Component.Canvas line 274, column 1 - line 274, column 64: " + [ v.constructor.name ]);
  };
  ...
  exports["ChangeWinding"] = ChangeWinding;
...
(function(exports) {
  ...
  var SetWinding = (function () {
      function SetWinding(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetWinding.create = function (value0) {
          return function (value1) {
              return new SetWinding(value0, value1);
          };
      };
      return SetWinding;
  })();
  ...
  var $$eval = function (v) {
      ...
      if (v instanceof SetWinding) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeWinding.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
  ...
  var render = function (v) {
      ...
      var mkNumInput = function (text) {
          return function (placeholder) {
              return function (query) {
                  return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(text + ": ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("attr-numeric"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueChange(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(toNatural)(Halogen_HTML_Events.input(query))), Halogen_HTML_Properties.title(text), Halogen_HTML_Properties.prop(Halogen_HTML_Core.intIsProp)("maxLength")(4), Halogen_HTML_Properties.placeholder(placeholder), Halogen_HTML_Properties.min(0.0) ]) ]);
              };
          };
      };
      var mkButton = function (text) {
          return function (class_) {
              return function (disabled) {
                  return function (query) {
                      return Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("pure-button button-" + class_), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(query)), Halogen_HTML_Properties.disabled(disabled), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Core.text(text) ]);
                  };
              };
          };
      };
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1-4 sidebar") ])([ mkButton("Toggle Representation")("primary")(false)(ToggleRepr.create), mkButton("Toggle Animation")("warning")(false)(ToggleAnimation.create), mkNumInput("Norm")(Data_Show.show(Data_Show.showInt)(Data_Maybe.fromMaybe(0)(Norm.getPrime(initNorm))))(SetNorm.create), mkNumInput("Winding Number")(Data_Show.show(Data_Show.showInt)(initWinding))(SetWinding.create), mkNumInput("Max Tick")(Data_Show.show(Data_Show.showInt)(initTick))(SetTick.create), mkNumInput("Max Int")(Data_Show.show(Data_Show.showInt)(initMaxInt))(SetMax.create), mkNumInput("Scale")(Data_Show.show(Data_Show.showInt)(initScale))(SetScale.create) ]);
