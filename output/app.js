  ...
  var normSqrt = function (v) {
      return function (v1) {
          if (v instanceof Norm.Inf) {
              return function ($5) {
                  return Data_List.singleton(Data_Int.round($$Math.sqrt(Data_Int.toNumber($5))));
              };
          };
          if (v instanceof Norm.Padic) {
              return Roots.pSqrt(v.value0)(v1);
          };
          throw new Error("Failed pattern match at Component.Bubble (line 17, column 1 - line 17, column 45): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var sqrtBubble = function (norm) {
      return function (steps) {
          return normSqrt(norm)(steps);
      };
  };
...
(function($PS) {
  ...
  var toggleRepr = function (model) {
      var newRepr = (function () {
          ...
          throw new Error("Failed pattern match at Component.Canvas (line 328, column 17 - line 330, column 32): " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          power: model.power,
  ...
  var mkColor = function (model) {
      return function (value) {
          ...
          var divisor = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 175, column 17 - line 178, column 7): " + [ model.coordType.constructor.name ]);
          })();
  ...
  var changeMax = function (power) {
      return function (model) {
          var x = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 340, column 11 - line 343, column 3): " + [ model.norm.constructor.name ]);
          })();
          return {
  ...
  var redraw = function (model) {
      ...
      return function __do() {
          ...
          throw new Error("Failed pattern match at Component.Canvas (line 355, column 5 - line 363, column 18): " + [ v.constructor.name ]);
      };
  };
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(regenBubbles))(function () {
              ...
              var cache = (function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas (line 310, column 15 - line 314, column 85): " + [ v.coordType.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $76 = {};
                  for (var $77 in v1) {
  ...
  var bubbleFn = function (norm) {
      return function (steps) {
          return function (inc) {
              if (inc.sqrt) {
                  return function ($147) {
                      return Component_Bubble.sqrtBubble(norm)(steps)(Component_Bubble.cubeBy(inc.cubeBy)(inc.sqrBy)(inc.multBy)(inc.addTo)($147));
                  };
              };
              return function ($148) {
                  return Data_List.singleton(Component_Bubble.cubeBy(inc.cubeBy)(inc.sqrBy)(inc.multBy)(inc.addTo)($148));
              };
          };
      };
  };
  var incBubble = function (model) {
      return function (inc) {
          return function (bubbles) {
              return function (idx) {
                  return setFromIdx(bubbles)(idx)(function ($149) {
                      return Data_Functor.map(Data_List_Types.functorList)(replaceBubble(model.maxInt)(inc))(bubbleFn(model.norm)(model.power)(inc)($149));
                  });
              };
          };
      };
  ...
  var $$eval = function (v) {
              ...
              if (v1.animate) {
                  ...
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $140.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $140;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(redrawStep)(function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas (line 407, column 7 - line 415, column 40): " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas (line 401, column 3 - line 415, column 40): " + [ v1.animate.constructor.name ]);
          });
      };
      ...
      throw new Error("Failed pattern match at Component.Canvas (line 373, column 1 - line 373, column 56): " + [ v.constructor.name ]);
  };
