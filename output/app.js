...
(function(exports) {
  ...
  var incValueBy = function (by) {
      return modifyBubble(function (b) {
          return setValue(getValue(b) + by | 0)(b);
      });
  };
  var multValueBy = function (by) {
      return modifyBubble(function (b) {
          return setValue(getValue(b) * by | 0)(b);
      });
  };
...
(function(exports) {
  ...
  var toggleRepr = function (model) {
      var newRepr = (function () {
          ...
          throw new Error("Failed pattern match at Component.Canvas line 295, column 17 - line 297, column 32: " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          norm: model.norm,
  ...
  var replaceBubble = function (cycle) {
      return function (maxInt) {
          return function (bubble) {
              ...
              var mold = Component_Bubble.getOldValue(bubble);
              var $29 = v <= maxInt && v >= 0;
              if ($29) {
                  return bubble;
              };
              var $$new = Component_Bubble.mkBubble(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v)(maxInt + 1 | 0));
              if (cycle) {
                  return Component_Bubble.bubbleWPast($$new)(new Data_Maybe.Just(0));
              };
              return $$new;
          };
      };
      ...
      return function (maxInt) {
          return function (inc) {
              return function (bubbles) {
                  return function (idx) {
                      return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(function ($102) {
                          return replaceBubble(cycle)(maxInt)(Component_Bubble.incValueBy(inc.addTo)(Component_Bubble.multValueBy(inc.multBy)($102)));
                      })(bubbles))(function (v) {
          ...
          var go = function ($copy_n$prime) {
              return function ($copy_m) {
                  ...
                  function $tco_loop(n$prime, m) {
                      ...
                      throw new Error("Failed pattern match at Component.Canvas line 103, column 5 - line 105, column 40: " + [ n$prime.constructor.name, m.constructor.name ]);
                  };
                  while (!$tco_done) {
  ...
  var getFullMax = function (model) {
      ...
      throw new Error("Failed pattern match at Component.Canvas line 111, column 5 - line 113, column 49: " + [ model.norm.constructor.name ]);
  };
  var incAll = function (model) {
      var maxInt = getFullMax(model);
      var changer = incBubble(model.cycle)(maxInt)({
          addTo: model.addTo,
          multBy: model.multBy
      });
  ...
  var redraw = function (model) {
      ...
      return function __do() {
          ...
          throw new Error("Failed pattern match at Component.Canvas line 317, column 5 - line 325, column 18: " + [ v.constructor.name ]);
      };
  };
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(regenBubbles))(function () {
              ...
              var cache = (function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas line 277, column 15 - line 281, column 85: " + [ v.coordType.constructor.name ]);
              })();
              ...
              if (v1.animate) {
                  ...
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $97.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $97;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(redraw(v1)))(function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas line 354, column 7 - line 362, column 40: " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas line 348, column 3 - line 362, column 40: " + [ v1.animate.constructor.name ]);
          });
      };
      if (v instanceof InitCaches) {
          return reinitCache(v.value0);
      };
      throw new Error("Failed pattern match at Component.Canvas line 327, column 1 - line 327, column 56: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var $$eval = function (v) {
      ...
      throw new Error("Failed pattern match at Component.App line 106, column 1 - line 106, column 80: " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      maxInt: 728,
