...
(function(exports) {
  ...
  var toggleRepr = function (model) {
      var newRepr = (function () {
          ...
          throw new Error("Failed pattern match at Component.Canvas line 281, column 17 - line 283, column 32: " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          norm: model.norm,
  ...
  var mkColor = function (model) {
      return function (value) {
          ...
          var divisor = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas line 151, column 17 - line 154, column 7: " + [ model.coordType.constructor.name ]);
          })();
  ...
  var maxValue = function (model) {
      var $34 = Norm.isPadic(model.norm);
      if ($34) {
          return 1;
      };
      return model.maxInt;
  ...
  var incBubble = function (maxInt) {
      return function (def) {
          return function (bubbles) {
              return function (idx) {
                  return Control_Bind.bind(Control_Monad_ST_Internal.bindST)(Data_Array_ST.modify(idx)(function ($94) {
                      return replaceBubble(maxInt)(def)(Component_Bubble.incValue($94));
                  })(bubbles))(function (v) {
  ...
  var redraw = function (model) {
      ...
      return function __do() {
          ...
          throw new Error("Failed pattern match at Component.Canvas line 301, column 5 - line 309, column 18: " + [ v.constructor.name ]);
      };
  };
              ...
              if (v1.animate) {
                  ...
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $89.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $89;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(redraw(v1)))(function () {
                  ...
                  throw new Error("Failed pattern match at Component.Canvas line 338, column 7 - line 346, column 40: " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas line 332, column 3 - line 346, column 40: " + [ v1.animate.constructor.name ]);
          });
      };
      if (v instanceof InitCaches) {
          return reinitCache(v.value0);
      };
      throw new Error("Failed pattern match at Component.Canvas line 311, column 1 - line 311, column 56: " + [ v.constructor.name ]);
  };
