...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Component.Animation"] = $PS["Component.Animation"] || {};
  var exports = $PS["Component.Animation"];
  ...
  var proportionalTick = function (dictMonadReader) {
      return function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(((dictMonadReader.MonadAsk0()).Monad0()).Applicative0())(1.0);
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(((dictMonadReader.MonadAsk0()).Monad0()).Bind1())(Control_Monad_Reader_Class.ask(dictMonadReader.MonadAsk0()))(function (v1) {
                  return Control_Applicative.pure(((dictMonadReader.MonadAsk0()).Monad0()).Applicative0())(Data_Int.toNumber(v.value0) / Data_Int.toNumber(v1));
              });
          };
  ...
  var interpolate = function (dictMonadReader) {
      return function (f) {
          return function (t) {
              return Control_Bind.bind(((dictMonadReader.MonadAsk0()).Monad0()).Bind1())(proportionalTick(dictMonadReader)(t))(function (v) {
                  return Control_Applicative.pure(((dictMonadReader.MonadAsk0()).Monad0()).Applicative0())(function (to) {
                      return function (from) {
                          return (to - from) * f(v) + from;
                      };
                  });
              });
          };
  ...
  var sinInterpolate = function (dictMonadReader) {
      return interpolate(dictMonadReader)(function ($27) {
          return Data_Function.flip($$Math.pow)(2.0)($$Math.sin((function (x) {
              return $$Math.pi * x - $$Math.pi / 4.0;
          })($27)));
      });
  };
  var sqrtInterpolate = function (dictMonadReader) {
      ...
      return interpolate(dictMonadReader)(function ($28) {
          return unstretch(cbrt(stretch($28)));
      });
  };
  var atMax = function (dictMonadReader) {
      return function (v) {
          return Control_Bind.bind(((dictMonadReader.MonadAsk0()).Monad0()).Bind1())(Control_Monad_Reader_Class.ask(dictMonadReader.MonadAsk0()))(function (v1) {
              return Control_Applicative.pure(((dictMonadReader.MonadAsk0()).Monad0()).Applicative0())(v >= v1);
          });
      };
  };
  var incTick = function (dictMonadReader) {
      return function (v) {
          return Control_Bind.bind(((dictMonadReader.MonadAsk0()).Monad0()).Bind1())(atMax(dictMonadReader)(v))(function (v1) {
              if (v1) {
                  return Control_Applicative.pure(((dictMonadReader.MonadAsk0()).Monad0()).Applicative0())(Data_Maybe.Nothing.value);
              };
              if (!v1) {
                  return Control_Applicative.pure(((dictMonadReader.MonadAsk0()).Monad0()).Applicative0())(new Data_Maybe.Just(v + 1 | 0));
              };
              throw new Error("Failed pattern match at Component.Animation (line 18, column 3 - line 20, column 40): " + [ v1.constructor.name ]);
          });
      };
  };
  exports["startTick"] = startTick;
  exports["incTick"] = incTick;
  exports["atMax"] = atMax;
  exports["proportionalTick"] = proportionalTick;
  exports["interpolate"] = interpolate;
  exports["sinInterpolate"] = sinInterpolate;
  exports["sqrtInterpolate"] = sqrtInterpolate;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var Padic = (function () {
      function Padic(value0) {
          this.value0 = value0;
      };
      Padic.create = function (value0) {
          return new Padic(value0);
      };
      return Padic;
  })();
  var takeNorm = function (v) {
      return function (v1) {
          ...
          if (v instanceof Inf) {
              return Data_Rational.fromInt(Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(v1));
          };
          if (v instanceof Padic) {
              var takeNormPower = function (m) {
                  if (Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(m)(v.value0) === 0) {
                      return 1 + takeNormPower(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(m)(v.value0)) | 0;
                  };
                  if (Data_Boolean.otherwise) {
                      return 0;
                  };
                  throw new Error("Failed pattern match at Norm (line 24, column 9 - line 26, column 25): " + [ m.constructor.name ]);
              };
              return Data_Ratio.reduce(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt)(1)(Data_Int.pow(2)(takeNormPower(v1)));
          };
  ...
  exports["isPadic"] = isPadic;
  exports["takeNorm"] = takeNorm;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
...
(function($PS) {
  ...
  var Data_Ord = $PS["Data.Ord"];
  var Data_Tuple = $PS["Data.Tuple"];                
  var recipMod = function (p) {
      return function (v) {
          if (v === 1) {
              return new Data_Maybe.Just(1);
          };
          var go = function ($copy_t) {
              return function ($copy_v1) {
                  return function ($copy_v2) {
                      return function ($copy_v3) {
                          ...
                          var $tco_done = false;
                          var $tco_result;
                          function $tco_loop(t, v1, v2, v3) {
                              if (v3 === 0) {
                                  $tco_done = true;
                                  return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(t)(p);
                              };
                              var q = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(v2)(v3);
                              $tco_var_t = v1;
                              $tco_var_v1 = t - (q * v1 | 0) | 0;
                              $tco_var_v2 = v3;
                              $copy_v3 = v2 - (q * v3 | 0) | 0;
                              return;
                          };
                          while (!$tco_done) {
                              $tco_result = $tco_loop($tco_var_t, $tco_var_v1, $tco_var_v2, $copy_v3);
                          };
                          return $tco_result;
                      };
                  };
          ...
          var $17 = Data_EuclideanRing.gcd(Data_Eq.eqInt)(Data_EuclideanRing.euclideanRingInt)(p)(v) === 1;
          if ($17) {
              return Data_Maybe.Just.create(go(0)(1)(p)(v));
          };
          return Data_Maybe.Nothing.value;
      };
  };
  var modRecips = function (p) {
      var ints = Data_List.range(0)(p - 1 | 0);
      var inverted = Data_Functor.map(Data_List_Types.functorList)(function (x) {
          return new Data_Tuple.Tuple(x, recipMod(p)(x));
      })(ints);
      return Data_Map_Internal.fromFoldable(Data_Ord.ordInt)(Data_List_Types.foldableList)(inverted);
  };
  var lookupOr = function (dictOrd) {
      return function (key) {
          return function (def) {
              return function (m) {
                  return Data_Maybe.fromMaybe(def)(Data_Map_Internal.lookup(dictOrd)(key)(m));
              };
          };
      };
  };
  var joinLists = function (ls) {
      return function (rs) {
          return Data_List.concat(new Data_List_Types.Cons(ls, new Data_List_Types.Cons(rs, Data_List_Types.Nil.value)));
      };
  };
  var modCubeRoots = function (p) {
      var ints = Data_List.range(0)(p - 1 | 0);
      var squared = Data_Functor.map(Data_List_Types.functorList)(function (x) {
          return new Data_Tuple.Tuple(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((x * x | 0) * x | 0)(p), Data_List.singleton(x));
      })(ints);
      return Data_Map_Internal.fromFoldableWith(Data_Ord.ordInt)(Data_List_Types.foldableList)(joinLists)(squared);
  };
  var pCbrt = function (v) {
      return function (v1) {
          return function (v2) {
              if (v2 === 0) {
                  return new Data_List_Types.Cons(0, Data_List_Types.Nil.value);
              };
              var roots = modCubeRoots(v);
              var recips = modRecips(v);
              var go = function ($copy_pk) {
                  return function ($copy_step) {
                      return function ($copy_n) {
                          return function ($copy_df) {
                              ...
                              var $tco_done = false;
                              var $tco_result;
                              function $tco_loop(pk, step, n, df) {
                                  if (step >= v1) {
                                      $tco_done = true;
                                      return n;
                                  };
                                  if (Data_Boolean.otherwise) {
                                      var f = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(((n * n | 0) * n | 0) - v2 | 0)(pk);
                                      var d = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(f * (v - df | 0) | 0)(v);
                                      $tco_var_pk = v * pk | 0;
                                      $tco_var_step = step + 1 | 0;
                                      $tco_var_n = n + (d * pk | 0) | 0;
                                      $copy_df = df;
                                      return;
                                  };
                                  throw new Error("Failed pattern match at Roots (line 86, column 5 - line 86, column 42): " + [ pk.constructor.name, step.constructor.name, n.constructor.name, df.constructor.name ]);
                              };
                              while (!$tco_done) {
              ...
              var getRoot = function (n) {
                  return lookupOr(Data_Ord.ordInt)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n)(v))(Data_List_Types.Nil.value)(roots);
              };
              var getRecip = function (n) {
                  return Data_List.fromFoldable(Data_Foldable.foldableMaybe)(lookupOr(Data_Ord.ordInt)(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(n)(v))(Data_Maybe.Nothing.value)(recips));
              };
              return Control_Bind.bind(Data_List_Types.bindList)(getRoot(v2))(function (y) {
                  return Control_Bind.bind(Data_List_Types.bindList)(getRecip((3 * y | 0) * y | 0))(function (df) {
                      return Control_Applicative.pure(Data_List_Types.applicativeList)(go(v)(1)(y)(df));
                  });
              });
          };
      };
  };
  var modRoots = function (p) {
      var ints = Data_List.range(0)(p - 1 | 0);
      var squared = Data_Functor.map(Data_List_Types.functorList)(function (x) {
          return new Data_Tuple.Tuple(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x * x | 0)(p), Data_List.singleton(x));
      })(ints);
      return Data_Map_Internal.fromFoldableWith(Data_Ord.ordInt)(Data_List_Types.foldableList)(joinLists)(squared);
  };
  var pSqrt = function (v) {
      return function (v1) {
          return function (v2) {
                      ...
                      return function ($copy_n) {
                          return function ($copy_df) {
                              ...
                              function $tco_loop(pk, step, n, df) {
                                  ...
                                  if (Data_Boolean.otherwise) {
                                      var f = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)((n * n | 0) - v2 | 0)(pk);
                                      var d = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(f * (v - df | 0) | 0)(v);
                                      $tco_var_pk = v * pk | 0;
                                      $tco_var_step = step + 1 | 0;
                                      $tco_var_n = n + (d * pk | 0) | 0;
                                  ...
                                  throw new Error("Failed pattern match at Roots (line 62, column 5 - line 62, column 42): " + [ pk.constructor.name, step.constructor.name, n.constructor.name, df.constructor.name ]);
                              };
                              while (!$tco_done) {
                                  $tco_result = $tco_loop($tco_var_pk, $tco_var_step, $tco_var_n, $copy_df);
                              };
              ...
              return Control_Bind.bind(Data_List_Types.bindList)(getRoot(v2))(function (y) {
                  return Control_Bind.bind(Data_List_Types.bindList)(getRecip(2 * y | 0))(function (df) {
                      return Control_Applicative.pure(Data_List_Types.applicativeList)(go(v)(1)(y)(df));
                  });
              });
          };
  ...
  exports["modRoots"] = modRoots;
  exports["modCubeRoots"] = modCubeRoots;
  exports["recipMod"] = recipMod;
  exports["modRecips"] = modRecips;
  exports["lookupOr"] = lookupOr;
  exports["pSqrt"] = pSqrt;
  exports["pCbrt"] = pCbrt;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Component.Bubble"] = $PS["Component.Bubble"] || {};
  var exports = $PS["Component.Bubble"];
  var Data_Function = $PS["Data.Function"];
  var Data_Int = $PS["Data.Int"];
  var Data_List = $PS["Data.List"];
  var $$Math = $PS["Math"];
  ...
  var normSqrt = function (v) {
      return function (v1) {
          if (v instanceof Norm.Inf) {
              return function ($10) {
                  return Data_List.singleton(Data_Int.round($$Math.sqrt(Data_Int.toNumber($10))));
              };
          };
          if (v instanceof Norm.Padic) {
              return Roots.pSqrt(v.value0)(v1);
          };
  ...
  var normCbrt = function (v) {
      return function (v1) {
          if (v instanceof Norm.Inf) {
              return function ($11) {
                  return Data_List.singleton(Data_Int.round(Data_Function.flip($$Math.pow)(1.0 / 3.0)(Data_Int.toNumber($11))));
              };
          };
          if (v instanceof Norm.Padic) {
              return Roots.pCbrt(v.value0)(v1);
          };
  ...
  exports["cubeBy"] = cubeBy;
  exports["normSqrt"] = normSqrt;
  exports["normCbrt"] = normCbrt;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["HalogenHelpers.Coordinates"] = $PS["HalogenHelpers.Coordinates"] || {};
  var exports = $PS["HalogenHelpers.Coordinates"];
...
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["PolarCoordinates"] = $PS["PolarCoordinates"] || {};
  var exports = $PS["PolarCoordinates"];
  var $$Math = $PS["Math"];
  var polarToCartesian = function (coords) {
      return {
  ...
  exports["mkPolar"] = mkPolar;
  exports["polarToCartesian"] = polarToCartesian;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["PadicVector"] = $PS["PadicVector"] || {};
  var exports = $PS["PadicVector"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_EuclideanRing = $PS["Data.EuclideanRing"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Int = $PS["Data.Int"];
  ...
  var Data_Semigroup = $PS["Data.Semigroup"];
  var $$Math = $PS["Math"];
  var PolarCoordinates = $PS["PolarCoordinates"];                
  var padicRep = function (p) {
      return function (x) {
          var go = function (y) {
              if (y === 0) {
                  return Data_List.singleton(0);
              };
              if (Data_Boolean.otherwise) {
                  var m = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(y)(p);
                  return new Data_List_Types.Cons(m, go(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(y - m | 0)(p)));
              };
              throw new Error("Failed pattern match at PadicVector (line 17, column 4 - line 21, column 38): " + [ y.constructor.name ]);
          };
          return go(x);
      };
  };
  var calcStep = function (p) {
      return function (n) {
          return function (d) {
              var theta = ($$Math.tau / Data_Int.toNumber(p)) * Data_Int.toNumber(d);
              var r = 1.0 / Data_Int.toNumber(Data_Int.pow(p)(n));
              return PolarCoordinates.mkPolar(r)(theta);
          };
      };
  };
  var toCoordList = function (maxLength) {
      return function (p) {
          return function (x) {
              var padic = padicRep(p)(x);
              var extra = Data_List.fromFoldable(Data_List_Lazy_Types.foldableList)(Data_List_Lazy.replicate(maxLength - Data_List.length(padic) | 0)(0));
              return Data_List.mapWithIndex(calcStep(p))(Data_Semigroup.append(Data_List_Types.semigroupList)(padic)(extra));
          };
      };
  };
  var baseCoordinates = {
  ...
  var toVector = function (max) {
      return function (p) {
          return function (x) {
              var maxP = padicRep(p)(max);
              var cl = toCoordList(Data_List.length(maxP))(p)(x);
              return Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                  return function (next) {
                      return addCoords(acc)(PolarCoordinates.polarToCartesian(next));
                  };
              })(baseCoordinates)(cl);
          };
      };
  };
  exports["padicRep"] = padicRep;
  exports["addCoords"] = addCoords;
  exports["calcStep"] = calcStep;
  exports["toCoordList"] = toCoordList;
  exports["baseCoordinates"] = baseCoordinates;
  exports["toVector"] = toVector;
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
  $PS["Component.Canvas"] = $PS["Component.Canvas"] || {};
  var exports = $PS["Component.Canvas"];
  var Color = $PS["Color"];
  var Component_Animation = $PS["Component.Animation"];
  var Component_Bubble = $PS["Component.Bubble"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var HalogenHelpers_Coordinates = $PS["HalogenHelpers.Coordinates"];
  var $$Math = $PS["Math"];
  var Norm = $PS["Norm"];
  var PadicVector_1 = $PS["PadicVector"];
  var PolarCoordinates = $PS["PolarCoordinates"];                
  var Slot = (function () {
      function Slot() {
  ...
  var ChangeMax = (function () {
      function ChangeMax(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeMax.create = function (value0) {
          return function (value1) {
              return new ChangeMax(value0, value1);
          };
      };
      return ChangeMax;
  })();
  var ChangeTick = (function () {
      function ChangeTick(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeTick.create = function (value0) {
          return function (value1) {
              return new ChangeTick(value0, value1);
          };
      };
      return ChangeTick;
  })();
  var ChangeNorm = (function () {
      function ChangeNorm(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeNorm.create = function (value0) {
          return function (value1) {
              return new ChangeNorm(value0, value1);
          };
      };
      return ChangeNorm;
  })();
  ...
  var ChangeAddTo = (function () {
      function ChangeAddTo(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeAddTo.create = function (value0) {
          return function (value1) {
              return new ChangeAddTo(value0, value1);
          };
      };
      return ChangeAddTo;
  })();
  var ChangeMultBy = (function () {
      function ChangeMultBy(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeMultBy.create = function (value0) {
          return function (value1) {
              return new ChangeMultBy(value0, value1);
          };
      };
      return ChangeMultBy;
  })();
  var ChangeQuadBy = (function () {
      function ChangeQuadBy(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeQuadBy.create = function (value0) {
          return function (value1) {
              return new ChangeQuadBy(value0, value1);
          };
      };
      return ChangeQuadBy;
  })();
  var ChangeCubeBy = (function () {
      function ChangeCubeBy(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeCubeBy.create = function (value0) {
          return function (value1) {
              return new ChangeCubeBy(value0, value1);
          };
      };
      return ChangeCubeBy;
  })();
  var ChangeSqrt = (function () {
      function ChangeSqrt(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeSqrt.create = function (value0) {
          return function (value1) {
              return new ChangeSqrt(value0, value1);
          };
      };
      return ChangeSqrt;
  })();
  var ChangeCbrt = (function () {
      function ChangeCbrt(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeCbrt.create = function (value0) {
          return function (value1) {
              return new ChangeCbrt(value0, value1);
          };
      };
      return ChangeCbrt;
  })();
  var ToggleRepr = (function () {
      ...
      ToggleRepr.create = function (value0) {
          return new ToggleRepr(value0);
      };
      return ToggleRepr;
  })();
  var ToggleLines = (function () {
      function ToggleLines(value0) {
          this.value0 = value0;
      };
      ToggleLines.create = function (value0) {
          return new ToggleLines(value0);
      };
      return ToggleLines;
  })();
  var ToggleAnimation = (function () {
      function ToggleAnimation(value0) {
          this.value0 = value0;
      };
      ToggleAnimation.create = function (value0) {
          return new ToggleAnimation(value0);
      };
      return ToggleAnimation;
  })();
  var InitCaches = (function () {
      function InitCaches(value0) {
          this.value0 = value0;
      };
      InitCaches.create = function (value0) {
          return new InitCaches(value0);
      };
      return InitCaches;
  })();
  var Reset = (function () {
  ...
  var MoveTick = (function () {
      function MoveTick(value0) {
          this.value0 = value0;
      };
      MoveTick.create = function (value0) {
          return new MoveTick(value0);
      };
      return MoveTick;
  })();
  var Circular = (function () {
      ...
      Circular.value = new Circular();
      return Circular;
  })();
  var PadicVector = (function () {
      function PadicVector() {

      };
      PadicVector.value = new PadicVector();
      return PadicVector;
  })();
  var toggleRepr = function (model) {
      var newRepr = (function () {
          ...
          throw new Error("Failed pattern match at Component.Canvas (line 359, column 17 - line 361, column 32): " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          power: model.power,
  ...
  var setFromIdx = function (array) {
      return function (idx) {
          return function (f) {
              return Control_Apply.applySecond(Control_Monad_ST_Internal.applyST)(Data_Array_ST.modify(idx)(Data_Function["const"](f(idx)))(array))(Control_Applicative.pure(Control_Monad_ST_Internal.applicativeST)(Data_Unit.unit));
          };
      };
  };
  ...
  var normalizeCoords = function (model) {
      return function (coords) {
          var offset = {
              top: 1.5 * Data_Int.toNumber(model.scale),
              left: 1.5 * Data_Int.toNumber(model.scale)
          };
  ...
  var mkColor = function (model) {
      return function (value) {
          ...
          var divisor = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 180, column 17 - line 183, column 7): " + [ model.coordType.constructor.name ]);
          })();
  ...
  var mkBubbles = function (maxInt) {
      return Data_Functor.map(Data_Functor.functorArray)(Data_List.singleton)(Data_Array.range(0)(maxInt));
  };
  ...
  var initialModel = function (input) {
      var maxInt = Data_Int.pow(Data_Maybe.fromMaybe(1)(Norm.getPrime(input.norm)))(input.power);
      return {
          power: input.power,
          norm: input.norm,
          maxInt: maxInt,
  ...
  var inRange = function (maxInt) {
      return function (v) {
          return v <= maxInt && v >= 0;
      };
  };
  var replaceBubble = function (maxInt) {
      return function (inc) {
          return function (v) {
              var $40 = inRange(maxInt)(v);
              if ($40) {
                  return v;
              };
              return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v)(maxInt + 1 | 0);
          };
      };
  };
  var getTheta = function (model) {
      return function (value) {
          return ($$Math.pi * 2.0 * Data_Int.toNumber(value)) / Data_Int.toNumber(model.maxInt);
      };
  };
  var getSize = function (model) {
      return Data_Int.round(4.0 * Data_Int.toNumber(model.scale));
  };
  var getR = function (model) {
      return function (value) {
          var maxValue = (function () {
              var $41 = Norm.isPadic(model.norm);
              if ($41) {
                  return 1;
              };
              return model.maxInt;
          })();
          return Data_EuclideanRing.div(Data_Ratio.euclideanRingRatio(Data_Ord.ordInt)(Data_EuclideanRing.euclideanRingInt))(value)(Data_Rational.fromInt(maxValue));
      };
  };
  var toPolar = function (model) {
      return function (n) {
          var theta = getTheta(model)(n);
          var r = getR(model)(Norm.takeNorm(model.norm)(n));
          return {
              r: Data_Rational.toNumber(r),
              theta: theta
          };
      };
  };
  var getPadicCoord = function (model) {
      return function (n) {
          ...
          return normalizeCoords(model)(PadicVector_1.toVector(model.maxInt)(p)(n));
      };
  };
  var getCoordinates = function (interpolater) {
      return function (cache) {
          return function (size) {
              return function (v) {
                  var $$new = Data_Maybe.fromMaybe(PadicVector_1.baseCoordinates)(Data_Map_Internal.lookup(Data_Ord.ordInt)(v.value1)(cache));
                  var mold = Data_Map_Internal.lookup(Data_Ord.ordInt)(v.value0)(cache);
                  var old = Data_Maybe.fromMaybe(HalogenHelpers_Coordinates.addOffset(PadicVector_1.baseCoordinates)({
                      top: size / 2.0,
                      left: size
                  }))(mold);
                  return {
  ...
  var getColor = function (interpolater) {
      return function (placer) {
          return function (cache) {
              return function (v) {
                  var interpolated = Data_Int.round(interpolater(Data_Int.toNumber(v.value1))(Data_Int.toNumber(v.value0)));
  ...
  var getCircleCoord = function (model) {
      return function (n) {
          return normalizeCoords(model)(PolarCoordinates.polarToCartesian(toPolar(model)(n)));
      };
  };
              ...
              return function (r) {
                  return function (color) {
                      return function __do() {
                          ...
                          Graphics_Canvas.moveTo(ctx)(start.x)(start.y)();
                          Graphics_Canvas.setStrokeStyle(ctx)(color)();
                          Graphics_Canvas.setLineWidth(ctx)(r)();
                          Graphics_Canvas.lineTo(ctx)(end.x)(end.y)();
                  ...
                  return function (colorGetter) {
                      return function (radius) {
                          return function (bubble) {
                              ...
                              return Control_Apply.applySecond(Effect.applyEffect)(drawCircle(ctx)(coords)(Data_Int.toNumber(radius))(color))((function () {
                                  if (model.lines) {
                                      return drawLine(ctx)(startCoords)(coords)(Data_Int.toNumber(radius))(color);
                                  };
  ...
  var distributeTuple = function (v) {
      return Data_Functor.map(Data_List_Types.functorList)(function (b) {
                  ...
                  return function (colorGetter) {
                      return function (radius) {
                          return function (bubbles) {
                              return Data_Foldable.for_(Effect.applicativeEffect)(Data_List_Types.foldableList)(distributeTuple(bubbles))(drawBubble(ctx)(model)(oldCoordGetter)(coordGetter)(colorGetter)(radius));
                          };
                      };
                  };
              };
  ...
  var changeMax = function (power) {
      return function (model) {
          var x = (function () {
              if (model.norm instanceof Norm.Padic) {
                  return model.norm.value0;
              };
              if (model.norm instanceof Norm.Inf) {
                  return 1;
              };
              throw new Error("Failed pattern match at Component.Canvas (line 371, column 11 - line 374, column 3): " + [ model.norm.constructor.name ]);
          })();
          return {
              maxInt: Data_Int.pow(x)(power) - 1 | 0,
              power: power,
              norm: model.norm,
              bubbles: model.bubbles,
              time: model.time,
  ...
  var redraw = function (model) {
      var sqrtInterp = Control_Monad_Reader.runReader(Component_Animation.sqrtInterpolate(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))(model.time))(model.maxTick);
      var sinInterp = Control_Monad_Reader.runReader(Component_Animation.sinInterpolate(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))(model.time))(model.maxTick);
      var oldCoordGetter = getCoordinates(function (x) {
          return function (y) {
              return y;
          };
      })(model.cache)(Data_Int.toNumber(getSize(model)));
      var coordGetter = getCoordinates(sqrtInterp)(model.cache)(Data_Int.toNumber(getSize(model)));
      var colorGetter = getColor(sqrtInterp)(numInPlace(model))(model.colorCache);
      ...
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Array.mapWithIndex(function (idx) {
                  return function (vs) {
                      return drawBubbles(v1)(model)(oldCoordGetter)(coordGetter)(colorGetter)(model.radius)(new Data_Tuple.Tuple(idx, vs));
                  };
              })(model.bubbles))();
              return Data_Unit.unit;
          };
          throw new Error("Failed pattern match at Component.Canvas (line 387, column 5 - line 396, column 18): " + [ v.constructor.name ]);
      };
  };
  var redrawStep = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
  ...
  var render = function (model) {
      ...
      return Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.width(size), Halogen_HTML_Properties.height(size), Halogen_HTML_Properties.id_(canvasId) ]);
  };
  var bubbleFn = function (norm) {
      return function (steps) {
          return function (inc) {
              var base = function ($154) {
                  return Data_List.singleton(Component_Bubble.cubeBy(inc.cubeBy)(inc.sqrBy)(inc.multBy)(inc.addTo)($154));
              };
              var sqrted = (function () {
                  if (inc.sqrt) {
                      return Control_Bind.composeKleisli(Data_List_Types.bindList)(base)(Component_Bubble.normSqrt(norm)(steps));
                  };
                  return base;
              })();
              var cbrted = (function () {
                  if (inc.cbrt) {
                      return Control_Bind.composeKleisli(Data_List_Types.bindList)(sqrted)(Component_Bubble.normCbrt(norm)(steps));
                  };
                  return sqrted;
              })();
              return cbrted;
  ...
  var incBubble = function (model) {
      return function (inc) {
          return function (bubbles) {
              return function (idx) {
                  return setFromIdx(bubbles)(idx)(function ($155) {
                      return Data_Functor.map(Data_List_Types.functorList)(replaceBubble(model.maxInt)(inc))(bubbleFn(model.norm)(model.power)(inc)($155));
                  });
              };
          };
      };
  ...
  var incAll = function (model) {
      ...
      var changer = incBubble(model)(inc);
      var newBubblesST = function (bubbles) {
          return function __do() {
              var v = Data_Array_ST.thaw(bubbles)();
              var v1 = Control_Monad_ST_Internal["for"](0)(Data_Array.length(bubbles))(changer(v))();
              return Data_Array_ST.freeze(v)();
          };
      };
      ...
      return {
          ...
          time: model.time,
          size: model.size,
          numIncs: Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)((model.multBy * model.numIncs | 0) + model.addTo | 0)(model.maxInt + 1 | 0),
          coordType: model.coordType,
          cache: model.cache,
          colorCache: model.colorCache,
          maxTick: model.maxTick,
  ...
  var reinitCache = function (next) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(regenBubbles))(function () {
              ...
              var cache = (function () {
                  if (v.coordType instanceof Circular) {
                      return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
                          return function (x) {
                              return Data_Map_Internal.insert(Data_Ord.ordInt)(x)(getCircleCoord(v)(x))(acc);
                          };
                      })(Data_Map_Internal.empty)(ints);
                  };
                  if (v.coordType instanceof PadicVector) {
                      return Data_Foldable.foldl(Data_Foldable.foldableArray)(function (acc) {
                          return function (x) {
                              return Data_Map_Internal.insert(Data_Ord.ordInt)(x)(getPadicCoord(v)(x))(acc);
                          };
                      })(Data_Map_Internal.empty)(ints);
                  };
                  throw new Error("Failed pattern match at Component.Canvas (line 337, column 15 - line 341, column 85): " + [ v.coordType.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $81 = {};
                  for (var $82 in v1) {
                  ...
                  $81.cache = cache;
                  $81.colorCache = colorCache;
                  return $81;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(redraw(v)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(incAll))(function () {
  ...
  var $$eval = function (v) {
      if (v instanceof ChangeMax) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(changeMax(v.value0)))(reinitCache(v.value1(Data_Unit.unit)));
      };
      ...
      if (v instanceof ToggleRepr) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(toggleRepr))(reinitCache(v.value0(Data_Unit.unit)));
      };
      if (v instanceof ToggleLines) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(toggleLines))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit)));
      };
      if (v instanceof ToggleAnimation) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(toggleAnimation))(reinitCache(v.value0(Data_Unit.unit)));
      };
      if (v instanceof MoveTick) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              ...
              if (v1.animate) {
                  var newTick = Control_Bind.bind(Data_Maybe.bindMaybe)(v1.time)(function (t) {
                      return Control_Monad_Reader.runReader(Component_Animation.incTick(Control_Monad_Reader_Trans.monadReaderReaderT(Data_Identity.monadIdentity))(t))(v1.maxTick);
                  });
                  if (newTick instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(redrawStep)(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
                          });
                      });
                  };
                  if (newTick instanceof Data_Maybe.Nothing) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $147.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $147;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(redrawStep)(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
                  ...
                  throw new Error("Failed pattern match at Component.Canvas (line 439, column 7 - line 447, column 28): " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas (line 433, column 3 - line 447, column 28): " + [ v1.animate.constructor.name ]);
          });
      };
      ...
      if (v instanceof Reset) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(changeMax(v1.power)))(function () {
                  return reinitCache(v.value0(Data_Unit.unit));
              });
          });
      };
      throw new Error("Failed pattern match at Component.Canvas (line 406, column 1 - line 406, column 56): " + [ v.constructor.name ]);
  };
  var component = Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
      ...
      initializer: Data_Maybe.Just.create(Halogen_Query.action(InitCaches.create)),
      finalizer: Data_Maybe.Nothing.value
  });
  exports["Slot"] = Slot;
  exports["Circular"] = Circular;
  exports["PadicVector"] = PadicVector;
  exports["mkBubbles"] = mkBubbles;
  ...
  exports["distributeTuple"] = distributeTuple;
  ...
  exports["ChangeAddTo"] = ChangeAddTo;
  exports["ChangeMultBy"] = ChangeMultBy;
  exports["ChangeQuadBy"] = ChangeQuadBy;
  exports["ChangeCubeBy"] = ChangeCubeBy;
  exports["ChangeSqrt"] = ChangeSqrt;
  exports["ChangeCbrt"] = ChangeCbrt;
  exports["ToggleRepr"] = ToggleRepr;
  exports["ToggleLines"] = ToggleLines;
  exports["ToggleAnimation"] = ToggleAnimation;
  exports["InitCaches"] = InitCaches;
  exports["Reset"] = Reset;
  exports["MoveTick"] = MoveTick;
  exports["inRange"] = inRange;
  exports["replaceBubble"] = replaceBubble;
  exports["bubbleFn"] = bubbleFn;
  exports["setFromIdx"] = setFromIdx;
  exports["incBubble"] = incBubble;
  exports["incAll"] = incAll;
  exports["reinitCache"] = reinitCache;
  exports["toggleAnimation"] = toggleAnimation;
  exports["toggleLines"] = toggleLines;
  exports["toggleRepr"] = toggleRepr;
  exports["regenBubbles"] = regenBubbles;
  exports["changeMax"] = changeMax;
  exports["redraw"] = redraw;
  exports["redrawStep"] = redrawStep;
...
(function($PS) {
  ...
  var compactableMaybe = new Compactable(Control_Bind.join(Data_Maybe.bindMaybe), function (v) {
      ...
      throw new Error("Failed pattern match at Data.Compactable (line 83, column 1 - line 83, column 47): " + [ v.constructor.name ]);
  });
  ...
  var bindMaybe = function (dictBind) {
      return function (dictCompactable) {
          return function (x) {
              return function ($67) {
                  return compact(dictCompactable)(Control_Bind.bind(dictBind)(x)($67));
              };
          };
      };
  };
...
(function($PS) {
  ...
  var filterableMaybe = new Filterable(function () {
      ...
      return function (v) {
          ...
          throw new Error("Failed pattern match at Data.Filterable (line 159, column 1 - line 159, column 45): " + [ p.constructor.name, v.constructor.name ]);
      };
  });
...
(function($PS) {
  ...
  var exports = $PS["HalogenHelpers.Communication"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_List_Types = $PS["Data.List.Types"];
...
(function($PS) {
  ...
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];
  var HalogenHelpers_Communication = $PS["HalogenHelpers.Communication"];
  var Norm = $PS["Norm"];                
  var SetNorm = (function () {
      function SetNorm(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetNorm.create = function (value0) {
          return function (value1) {
              return new SetNorm(value0, value1);
          };
      };
      return SetNorm;
  })();
  var SetMax = (function () {
      function SetMax(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetMax.create = function (value0) {
          return function (value1) {
              return new SetMax(value0, value1);
          };
      };
      return SetMax;
  })();
  var SetTick = (function () {
      function SetTick(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetTick.create = function (value0) {
          return function (value1) {
              return new SetTick(value0, value1);
          };
      };
      return SetTick;
  })();
  var SetScale = (function () {
      function SetScale(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetScale.create = function (value0) {
          return function (value1) {
              return new SetScale(value0, value1);
          };
      };
      return SetScale;
  })();
  ...
  var SetAdd = (function () {
      function SetAdd(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetAdd.create = function (value0) {
          return function (value1) {
              return new SetAdd(value0, value1);
          };
      };
      return SetAdd;
  })();
  var SetMult = (function () {
      function SetMult(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetMult.create = function (value0) {
          return function (value1) {
              return new SetMult(value0, value1);
          };
      };
      return SetMult;
  })();
  var SetQuad = (function () {
      function SetQuad(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetQuad.create = function (value0) {
          return function (value1) {
              return new SetQuad(value0, value1);
          };
      };
      return SetQuad;
  })();
  var SetCube = (function () {
      function SetCube(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetCube.create = function (value0) {
          return function (value1) {
              return new SetCube(value0, value1);
          };
      };
      return SetCube;
  })();
  ...
  var $$eval = function (v) {
      if (v instanceof SetNorm) {
          var norm = (function () {
              var $4 = v.value0 <= 1;
              if ($4) {
                  return Norm.Inf.value;
              };
              return new Norm.Padic(v.value0);
          })();
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeNorm.create(norm)))(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.Reset.create)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof SetMax) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeMax.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof SetTick) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeTick.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      ...
      if (v instanceof SetAdd) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeAddTo.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof SetMult) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeMultBy.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof SetQuad) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeQuadBy.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof SetCube) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeCubeBy.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof ChangeSqrt) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeSqrt.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof ChangeCbrt) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeCbrt.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
      if (v instanceof ToggleRepr) {
      ...
      if (v instanceof ToggleLines) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ToggleLines.create))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0));
      };
      if (v instanceof ToggleAnimation) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ToggleAnimation.create))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0));
      };
      if (v instanceof Reset) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.Reset.create))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0));
      };
      if (v instanceof Tick) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.MoveTick.create))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0));
      };
      if (v instanceof HandleMessage) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
      };
      throw new Error("Failed pattern match at Component.App (line 138, column 1 - line 138, column 80): " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      power: 5,
      norm: new Norm.Padic(3),
  ...
  var render = function (v) {
      var withDescription = function (inputDiv) {
          return function (descr) {
              return function (class_) {
                  var descrDiv = Data_Maybe.maybe([  ])(function (txt) {
                      return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("description") ])([ Halogen_HTML_Core.text(txt) ]) ];
                  })(descr);
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(class_) ])(Data_Array.cons(inputDiv)(descrDiv));
              };
          };
      };
      ...
      var mkNumInput = function (text) {
          return function (placeholder) {
              return function (descr) {
                  return function (query) {
                      var inputDiv = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(text + ": ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("attr-numeric"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputNumber.value), Halogen_HTML_Events.onValueChange(Control_Bind.composeKleisli(Data_Maybe.bindMaybe)(toNatural)(Halogen_HTML_Events.input(query))), Halogen_HTML_Properties.title(text), Halogen_HTML_Properties.prop(Halogen_HTML_Core.intIsProp)("maxLength")(4), Halogen_HTML_Properties.placeholder(placeholder), Halogen_HTML_Properties.min(0.0) ]) ]);
                      return withDescription(inputDiv)(descr)("input-div");
                  };
              };
          };
      };
      var mkCheckbox = function (text) {
          return function (descr) {
              return function (query) {
                  var inputDiv = Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(text + ": ") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("attr-boolean"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(query)), Halogen_HTML_Properties.title(text) ]) ]);
      ...
      var mkButton = function (text) {
          return function (class_) {
              return function (description) {
                  return function (query) {
                      var buttonDiv = Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_("pure-button button-" + class_), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(query)), Halogen_HTML_Properties.type_(Halogen_HTML_Core.buttonTypeIsProp)(DOM_HTML_Indexed_ButtonType.ButtonButton.value) ])([ Halogen_HTML_Core.text(text) ]);
                      return withDescription(buttonDiv)(description)("button-div");
                  };
              };
          };
      };
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1-4 sidebar") ])([ mkButton("Toggle Representation")("primary")(new Data_Maybe.Just("Between fractal given by the p-adic representation, or circles given by the p-adic norm"))(ToggleRepr.create), mkButton("Toggle Animation")("warning")(new Data_Maybe.Just("Turn animation on and off"))(ToggleAnimation.create), mkButton("Toggle Lines")("secondary")(new Data_Maybe.Just("Turn lines on and off"))(ToggleLines.create), mkButton("Reset")("error")(new Data_Maybe.Just("Reset animation"))(Reset.create), mkNumInput("_-adic Norm")(Data_Show.show(Data_Show.showInt)(Data_Maybe.fromMaybe(0)(Norm.getPrime(baseInput.norm))))(new Data_Maybe.Just("<= 1 yields normal absolute value; 2 and above use p-adic norm"))(SetNorm.create), mkNumInput("# of Frames")(Data_Show.show(Data_Show.showInt)(baseInput.maxTick))(new Data_Maybe.Just("Frames between each position; controls speed of animation"))(SetTick.create), mkNumInput("p^# of Circles")(Data_Show.show(Data_Show.showInt)(baseInput.power))(new Data_Maybe.Just("Use this p^(power) many circles; for example, in the 3-adic norm, setting this to 3 will use 27 circles"))(SetMax.create), mkNumInput("Scale")(Data_Show.show(Data_Show.showInt)(baseInput.scale))(new Data_Maybe.Just("Controls distance between dots"))(SetScale.create), mkNumInput("Radius")(Data_Show.show(Data_Show.showInt)(baseInput.radius))(new Data_Maybe.Just("Controls size of dots"))(SetRadius.create), mkNumInput("Constant Term")(Data_Show.show(Data_Show.showInt)(baseInput.addTo))(new Data_Maybe.Just("Set constant term in ax^3 + bx^2 + cx + d"))(SetAdd.create), mkNumInput("Linear Coefficient")(Data_Show.show(Data_Show.showInt)(baseInput.multBy))(new Data_Maybe.Just("Set linear component"))(SetMult.create), mkNumInput("Quad Coefficient")(Data_Show.show(Data_Show.showInt)(baseInput.quadCoeff))(new Data_Maybe.Just("Set quadratic component"))(SetQuad.create), mkNumInput("Cubic Coefficient")(Data_Show.show(Data_Show.showInt)(baseInput.cubeCoeff))(new Data_Maybe.Just("Set cubic component"))(SetCube.create), mkCheckbox("Square Root?")(new Data_Maybe.Just("Take square root of the above"))(ChangeSqrt.create), mkCheckbox("Cube Root?")(new Data_Maybe.Just("Take cube root of the above"))(ChangeCbrt.create) ]);
  ...
  exports["SetQuad"] = SetQuad;
  exports["SetCube"] = SetCube;
  exports["ChangeSqrt"] = ChangeSqrt;
  exports["ChangeCbrt"] = ChangeCbrt;
  exports["ToggleRepr"] = ToggleRepr;
  exports["ToggleAnimation"] = ToggleAnimation;
...
(function($PS) {
  ...
  var tickDelay = 1.0 / 60.0;
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Component_App.component)(Data_Unit.unit)(v))(function (v1) {
          return Control_Monad_Rec_Class.forever(Effect_Aff.monadRecAff)(Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.delay(tickDelay))(function (v2) {
              return Data_Functor["void"](Effect_Aff.functorAff)(v1.query(Halogen_Query.action(Component_App.Tick.create)));
          }));
      });
  }));
