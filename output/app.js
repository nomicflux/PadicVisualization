...
(function($PS) {
  ...
  var quadBy = function (sqr) {
      return function (by) {
          return function (plus) {
              return modifyBubble(function (b) {
                  var v = getValue(b);
                  return setValue((((v * v | 0) * sqr | 0) + (v * by | 0) | 0) + plus | 0)(b);
              });
          };
      };
  };
...
<<<<<<< HEAD
  exports["linearBy"] = linearBy;
=======
  exports["quadBy"] = quadBy;
>>>>>>> effd869 (start quadratic version)
})(PS);
(function($PS) {
  // Generated by purs version 0.12.5
  "use strict";
...
=======
  ...
  var ChangeCycle = (function () {
      function ChangeCycle(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeCycle.create = function (value0) {
          return function (value1) {
              return new ChangeCycle(value0, value1);
          };
      };
      return ChangeCycle;
  })();
...
<<<<<<< HEAD
          throw new Error("Failed pattern match at Component.Canvas (line 304, column 17 - line 306, column 32): " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
          power: model.power,
=======
          throw new Error("Failed pattern match at Component.Canvas (line 326, column 17 - line 328, column 32): " + [ model.coordType.constructor.name ]);
      })();
      return {
          maxInt: model.maxInt,
>>>>>>> effd869 (start quadratic version)
  ...
  var mkColor = function (model) {
      return function (value) {
          ...
          var divisor = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 173, column 17 - line 176, column 7): " + [ model.coordType.constructor.name ]);
          })();
...
=======
  ...
  var invert = function (inc) {
      return function (n) {
          return Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(n - inc.addTo | 0)(inc.multBy);
      };
  };
  var initialModel = function (input) {
      return {
  ...
  var incBubble = function (maxInt) {
      return function (inc) {
          return function (bubbles) {
              return function (idx) {
                  return function __do() {
                      var v = Data_Array_ST.modify(idx)(function ($111) {
                          return replaceBubble(maxInt)(inc)(Component_Bubble.linearBy(inc.multBy)(inc.addTo)($111));
                      })(bubbles)();
                      return Data_Unit.unit;
=======
  var replaceBubble = function (cycle) {
      return function (maxInt) {
          return function (inc) {
              return function (bubble) {
                  var $34 = inRange(maxInt)(bubble);
                  if ($34) {
                  ...
                  var $$new = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(Component_Bubble.getValue(bubble))(maxInt + 1 | 0);
                  var inverted = invert(inc)($$new);
                  if (cycle) {
                      return Component_Bubble.setValue($$new)(bubble);
                  };
                  return Component_Bubble.changeValue($$new)(Component_Bubble.mkBubble(inverted));
              };
          };
      };
  };
  var incBubble = function (cycle) {
      return function (maxInt) {
          return function (inc) {
              return function (bubbles) {
                  return function (idx) {
                      return function __do() {
                          var v = Data_Array_ST.modify(idx)(function ($125) {
                              return replaceBubble(cycle)(maxInt)(inc)(Component_Bubble.quadBy(inc.sqrBy)(inc.multBy)(inc.addTo)($125));
                          })(bubbles)();
                          return Data_Unit.unit;
                      };
>>>>>>> effd869 (start quadratic version)
...
<<<<<<< HEAD
  var incAll = function (model) {
      ...
      var changer = incBubble(model.maxInt)(inc);
  ...
  var getR = function (model) {
      return function (value) {
          var maxValue = (function () {
              var $36 = Norm.isPadic(model.norm);
              if ($36) {
                  return 1;
              };
              return model.maxInt;
...
=======
      ...
      return function (n) {
          var go = function ($copy_n$prime) {
              return function ($copy_m) {
                  ...
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(n$prime, m) {
                      if (n$prime < p) {
                          $tco_done = true;
                          return m + 1 | 0;
                      };
                      if (Data_Boolean.otherwise) {
                          $tco_var_n$prime = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(n$prime)(p);
                          $copy_m = m + 1 | 0;
                          return;
                      };
                      throw new Error("Failed pattern match at Component.Canvas (line 105, column 5 - line 107, column 40): " + [ n$prime.constructor.name, m.constructor.name ]);
                  };
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_n$prime, $copy_m);
                  };
                  return $tco_result;
              };
          };
  ...
  var getFullMax = function (model) {
      if (model.cycle) {
          if (model.norm instanceof Norm.Inf) {
              return model.maxInt;
          };
          if (model.norm instanceof Norm.Padic) {
              return Data_Int.pow(model.norm.value0)(getPower(model.norm.value0)(model.maxInt));
          };
          throw new Error("Failed pattern match at Component.Canvas (line 112, column 8 - line 114, column 47): " + [ model.norm.constructor.name ]);
      };
      return model.maxInt;
  };
  var getPadicCoord = function (model) {
      return function (n) {
          ...
          return normalizeCoords(model)(PadicVector_1.toVector(getFullMax(model))(p)(n));
      };
  };
  var getTheta = function (model) {
      return function (value) {
          return ($$Math.pi * 2.0 * Data_Int.toNumber(value)) / Data_Int.toNumber(getFullMax(model));
      };
  };
>>>>>>> effd869 (start quadratic version)
...
=======
  var incAll = function (model) {
      ...
      var changer = incBubble(model.cycle)(maxInt)(inc);
      var newBubblesST = function (bubbles) {
          return function __do() {
              var v = Data_Array_ST.thaw(bubbles)();
              var v1 = Control_Monad_ST_Internal["for"](0)(Data_Array.length(bubbles))(changer(v))();
  ...
  var mkColor = function (model) {
      return function (value) {
          ...
          var divisor = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 187, column 17 - line 190, column 7): " + [ model.coordType.constructor.name ]);
          })();
          var step = 360.0 / Data_Int.toNumber(Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(getFullMax(model) + 1 | 0)(divisor));
          var hue = step * Data_Int.toNumber(value);
          return Color.toHexString(Color.hsv(hue)(1.0)(1.0));
      };
  };
  var numInPlace = function (model) {
      return function (x) {
          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(x - model.numIncs | 0)(getFullMax(model) + 1 | 0);
>>>>>>> effd869 (start quadratic version)
      };
  };
  ...
  var changeMax = function (power) {
      return function (model) {
          var x = (function () {
              ...
              throw new Error("Failed pattern match at Component.Canvas (line 316, column 11 - line 319, column 3): " + [ model.norm.constructor.name ]);
          })();
          return {
...
<<<<<<< HEAD
          throw new Error("Failed pattern match at Component.Canvas (line 331, column 5 - line 339, column 18): " + [ v.constructor.name ]);
=======
          throw new Error("Failed pattern match at Component.Canvas (line 348, column 5 - line 356, column 18): " + [ v.constructor.name ]);
>>>>>>> effd869 (start quadratic version)
      };
  };
...
=======
              var ints = Data_Array.range(0)(getFullMax(v));
>>>>>>> effd869 (start quadratic version)
...
<<<<<<< HEAD
                  throw new Error("Failed pattern match at Component.Canvas (line 286, column 15 - line 290, column 85): " + [ v.coordType.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $57 = {};
                  for (var $58 in v1) {
                  ...
                  $57.cache = cache;
                  $57.colorCache = colorCache;
                  return $57;
=======
                  throw new Error("Failed pattern match at Component.Canvas (line 308, column 15 - line 312, column 85): " + [ v.coordType.constructor.name ]);
              })();
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $62 = {};
                  for (var $63 in v1) {
...
<<<<<<< HEAD
                          ...
                          $104.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $104;
=======
                          var $119 = {};
                          for (var $120 in v2) {
                          ...
                          $119.time = new Data_Maybe.Just(Component_Animation.startTick);
                          return $119;
>>>>>>> effd869 (start quadratic version)
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(redrawStep)(function () {
...
<<<<<<< HEAD
                  throw new Error("Failed pattern match at Component.Canvas (line 377, column 7 - line 385, column 40): " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas (line 371, column 3 - line 385, column 40): " + [ v1.animate.constructor.name ]);
=======
                  throw new Error("Failed pattern match at Component.Canvas (line 397, column 7 - line 405, column 40): " + [ newTick.constructor.name ]);
              };
              throw new Error("Failed pattern match at Component.Canvas (line 391, column 3 - line 405, column 40): " + [ v1.animate.constructor.name ]);
>>>>>>> effd869 (start quadratic version)
          });
      };
...
<<<<<<< HEAD
      ...
      throw new Error("Failed pattern match at Component.Canvas (line 349, column 1 - line 349, column 56): " + [ v.constructor.name ]);
=======
          return reinitCache(v.value0(Data_Unit.unit));
      };
      throw new Error("Failed pattern match at Component.Canvas (line 366, column 1 - line 366, column 56): " + [ v.constructor.name ]);
>>>>>>> effd869 (start quadratic version)
  };
...
=======
  ...
  var SetCycle = (function () {
      function SetCycle(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SetCycle.create = function (value0) {
          return function (value1) {
              return new SetCycle(value0, value1);
          };
      };
      return SetCycle;
  })();
...
<<<<<<< HEAD
  var toNatural = function ($25) {
      return Data_Filterable.filter(Data_Filterable.filterableMaybe)(function (v) {
          return v >= 0;
      })(Data_Int.fromString($25));
=======
  var toNatural = function ($29) {
      return Data_Filterable.filter(Data_Filterable.filterableMaybe)(function (v) {
          return v >= 0;
      })(Data_Int.fromString($29));
>>>>>>> effd869 (start quadratic version)
  };
  var $$eval = function (v) {
...
=======
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeNorm.create(norm)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
>>>>>>> effd869 (start quadratic version)
      };
...
=======
      ...
      if (v instanceof SetCycle) {
          return Control_Apply.applySecond(Halogen_Query_HalogenM.applyHalogenM)(HalogenHelpers_Communication.passAlong(Component_Canvas.eqSlot)(Component_Canvas.ChangeCycle.create(v.value0)))(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1));
      };
>>>>>>> effd869 (start quadratic version)
      if (v instanceof ToggleRepr) {
...
<<<<<<< HEAD
      throw new Error("Failed pattern match at Component.App (line 126, column 1 - line 126, column 80): " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      power: 5,
=======
      throw new Error("Failed pattern match at Component.App (line 131, column 1 - line 131, column 80): " + [ v.constructor.name ]);
  };
  var baseInput = {
      size: 1024,
      maxInt: 728,
...
<<<<<<< HEAD
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1-4 sidebar") ])([ mkButton("Toggle Representation")("primary")(new Data_Maybe.Just("Between fractal given by the p-adic representation, or circles given by the p-adic norm"))(ToggleRepr.create), mkButton("Toggle Animation")("warning")(new Data_Maybe.Just("Turn animation on and off"))(ToggleAnimation.create), mkButton("Reset")("error")(new Data_Maybe.Just("Reset animation"))(Reset.create), mkNumInput("_-adic Norm")(Data_Show.show(Data_Show.showInt)(Data_Maybe.fromMaybe(0)(Norm.getPrime(baseInput.norm))))(new Data_Maybe.Just("<= 1 yields normal absolute value; 2 and above use p-adic norm"))(SetNorm.create), mkNumInput("# of Frames")(Data_Show.show(Data_Show.showInt)(baseInput.maxTick))(new Data_Maybe.Just("Frames between each position; controls speed of animation"))(SetTick.create), mkNumInput("# of Circles")(Data_Show.show(Data_Show.showInt)(baseInput.power))(new Data_Maybe.Just("Use this p^(power) many circles; for example, in the 3-adic norm, setting this to 3 will use 27 circles"))(SetMax.create), mkNumInput("Scale")(Data_Show.show(Data_Show.showInt)(baseInput.scale))(new Data_Maybe.Just("Controls distance between dots"))(SetScale.create), mkNumInput("Radius")(Data_Show.show(Data_Show.showInt)(baseInput.radius))(new Data_Maybe.Just("Controls size of dots"))(SetRadius.create), mkNumInput("Add To")(Data_Show.show(Data_Show.showInt)(baseInput.addTo))(Data_Maybe.Nothing.value)(SetAdd.create), mkNumInput("Mult By")(Data_Show.show(Data_Show.showInt)(baseInput.multBy))(new Data_Maybe.Just("For \"Add To\" b and \"Mult By\" a, this will change a number n to a*n + b"))(SetMult.create) ]);
=======
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1-4 sidebar") ])([ mkButton("Toggle Representation")("primary")(new Data_Maybe.Just("Between fractal given by the p-adic representation, or circles given by the p-adic norm"))(ToggleRepr.create), mkButton("Toggle Animation")("warning")(new Data_Maybe.Just("Turn animation on and off"))(ToggleAnimation.create), mkButton("Reset")("error")(new Data_Maybe.Just("Reset animation"))(Reset.create), mkCheckbox("Cycle")(new Data_Maybe.Just("Wrap numbers around from the next highest power of the norm after Max Int to Zero cyclically"))(SetCycle.create), mkNumInput("_-adic Norm")(Data_Show.show(Data_Show.showInt)(Data_Maybe.fromMaybe(0)(Norm.getPrime(baseInput.norm))))(new Data_Maybe.Just("<= 1 yields normal absolute value; 2 and above use p-adic norm"))(SetNorm.create), mkNumInput("# of Frames")(Data_Show.show(Data_Show.showInt)(baseInput.maxTick))(new Data_Maybe.Just("Frames between each position; controls speed of animation"))(SetTick.create), mkNumInput("# of Circles")(Data_Show.show(Data_Show.showInt)(baseInput.maxInt))(new Data_Maybe.Just("Use this many circles; for best results, use a power of the number used for the p-adic norm minus one, especially if changing Add To and Mult By"))(SetMax.create), mkNumInput("Scale")(Data_Show.show(Data_Show.showInt)(baseInput.scale))(new Data_Maybe.Just("Controls distance between dots"))(SetScale.create), mkNumInput("Radius")(Data_Show.show(Data_Show.showInt)(baseInput.radius))(new Data_Maybe.Just("Controls size of dots"))(SetRadius.create), mkNumInput("Add To")(Data_Show.show(Data_Show.showInt)(baseInput.addTo))(Data_Maybe.Nothing.value)(SetAdd.create), mkNumInput("Mult By")(Data_Show.show(Data_Show.showInt)(baseInput.multBy))(new Data_Maybe.Just("For \"Add To\" b and \"Mult By\" a, this will change a number n to a*n + b"))(SetMult.create), mkNumInput("Quad Coefficient")(Data_Show.show(Data_Show.showInt)(baseInput.quadCoeff))(new Data_Maybe.Just("Set quadratic component"))(SetQuad.create) ]);
>>>>>>> effd869 (start quadratic version)
